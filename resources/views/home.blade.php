            ...
            <div class="container mx-auto px-4 md:px-10">
                ...
                <div class="mx-auto grid grid-cols-2 gap-4 md:gap-9 md:w-full lg:w-5/6">
                    ...
                    <div class="flex flex-col items-start">
                        ...
                        <h4 class="text-xs md:text-base uppercase font-medium font-montserrat tracking-widest text-primary">
                            Start with
                            Diamonds</h4>
                    </div>
        ...
        <section class="py-7 md:py-16">
            ...
            <div class="mx-4 md:mx-auto grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-9 md:w-5/6">
                ...
                <div class="flex flex-col items-start">
                    ...
                    <h4 class="text-xs md:text-sm uppercase font-semibold font-montserrat tracking-widest text-primary">
                        Wedding Rings</h4>
                </div>
