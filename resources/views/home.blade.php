...
@section('content')
    <div class="bg-gray-50">
        <!-- Hero Section -->
        <section
            class="relative h-[550px] md:h-[600px] lg:h-[450px] xl:h-[480px] flex md:pt-12 lg:items-center justify-center">
            ...
            <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
                    <a href="{{ route('inventory') }}"
                        class="font-montserrat font-semibold tracking-wide text-center w-full md:w-3/5 lg:w-2/5 xl:w-2/6 md:px-8 lg:px-8 py-4 bg-primary text-gold hover:bg-white hover:text-primary border hover:border-primary transition duration-300">
                        Shop Lab Grown Diamonds
                    </a>
                    <a href="{{ route('build-a-ring') }}"
                        class="font-montserrat font-semibold tracking-wide text-center w-full md:w-3/5 lg:w-2/5 xl:w-2/6 md:px-8 lg:px-8 py-4 bg-primary text-gold hover:bg-white border hover:border-primary transition duration-300 hover:text-primary">
                ...
                <div class="mx-auto grid grid-cols-2 gap-4 md:gap-9 md:w-full lg:w-5/6">
                    ...
                    <a href="{{ route('inventory') }}" class="block">
                        <div class="flex flex-col items-start">
                            ...
                            <h4
                                class="text-xs md:text-base uppercase font-medium font-montserrat tracking-widest text-primary">
                                Start with Diamonds
                            </h4>
                        </div>
                    </a>
        ...
        <section class="py-7 xl:py-10 2xl:py-16 bg-light-blue-2">
            <div class="container mx-auto px-10">
                <h3
                    class="text-center text-2xl md:text-4xl lg:text-40px font-literata font-medium md:leading-[59px] text-primary/90 py-3">
                ...
                <div class="grid grid-cols-3 gap-7 md:gap-2 lg:gap-5 md:grid-cols-5 lg:grid-cols-10 lg:mb-5">
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'round']) }}"
                            ...
                            <img src="{{ asset('Shape/round.svg') }}" class="mb-2" width="60" height="60"
                                alt="Round Shape">
                            Round
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'princess']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/princess.svg') }}" class="mb-2" width="60" height="60"
                                alt="Princess Shape">
                            Princess
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'radiant']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/radiant.svg') }}" class="mb-2" width="60" height="60"
                                alt="Radiant Shape">
                            Radiant
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'asscher']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/asscher.svg') }}" class="mb-2" width="60" height="60"
                                alt="Asscher Shape">
                            Asscher
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'cushion']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/cushion.svg') }}" class="mb-2" width="60" height="60"
                                alt="Cushion Shape">
                            Cushion
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'oval']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/oval.svg') }}" class="mb-2" width="60" height="60"
                                alt="Oval Shape">
                            Oval
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'emerald']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/emerald.svg') }}" class="mb-2" width="60" height="60"
                                alt="Emerald Shape">
                            Emerald
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'pear']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/pear.svg') }}" class="mb-2" width="60" height="60"
                                alt="Pear Shape">
                            Pear
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'marquise']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/marquise.svg') }}" class="mb-2" width="60" height="60"
                                alt="Marquise Shape">
                            Marquise
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'heart']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/heart.svg') }}" class="mb-2" width="60" height="60"
                                alt="Heart Shape">
                            Heart
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'rose-cut']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/rose-cut.svg') }}" class="mb-2" width="60" height="60"
                                alt="Rose Cut Shape">
                            Rose Cut
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'old-european']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/old-european.svg') }}" class="mb-2" width="60"
                                height="60" alt="Old European Shape">
                            Old European
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'half-moon']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/half-moon.svg') }}" class="mb-2" width="60" height="60"
                                alt="Half Moon Shape">
                            Half Moon
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'baguette-trapezoid']) }}"
                            ...
                            <img src="{{ asset('Shape/baguette-trapezoid.svg') }}" class="mb-2" width="60"
                                height="60" alt="Baguette Trapezoid Shape">
                            Baguette Trapezoid
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'baguette']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/baguette.svg') }}" class="mb-2" width="60" height="60"
                                alt="Baguette Shape">
                            Baguette
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'hexagon']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/hexagon.svg') }}" class="mb-2" width="60" height="60"
                                alt="Hexagon Shape">
                            Hexagon
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'kite']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/kite.svg') }}" class="mb-2" width="60" height="60"
                                alt="Kite Shape">
                            Kite
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'old-mine']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/old-mine.svg') }}" class="mb-2" width="60" height="60"
                                alt="Old Mine Shape">
                            Old Mine
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'trapezoid']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/trapezoid.svg') }}" class="mb-2" width="60" height="60"
                                alt="Trapezoid Shape">
                            Trapezoid
                        </a>
                    </div>
                    ...
                    <div class="hover:bg-light-blue-1 p-4">
                        <a href="{{ route('inventory', ['shape' => 'triangular']) }}"
                            class="uppercase font-montserrat text-13px text-center leading-5 font-medium flex flex-col items-center">
                            <img src="{{ asset('Shape/triangular.svg') }}" class="mb-2" width="60" height="60"
            ...
            <div class="flex justify-center">
                <a href="{{ route('inventory') }}"
                    class="font-montserrat font-semibold tracking-wide px-8 py-4 bg-primary text-sm text-gold hover:bg-white hover:text-primary border border-primary hover:border-primary transition duration-300">
                    Shop Lab Grown Diamonds
                </a>
            </div>
        </section>
        ...
        <section class="py-7 md:py-16">
            <div class="container mx-auto px-6 pb-7">
                <h2
                    class="text-base md:text-xl lg:text-2xl 2xl:text-3xl font-montserrat font-medium uppercase text-center text-primary">
                    Fine Jewelry</h2>
            </div>
            <div class="mx-4 md:mx-auto grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-9 md:w-5/6">
                <!-- First Image Card -->
                <a href="{{ route('wedding-rings') }}" class="block">
                    <div class="flex flex-col items-start">
                        ...
                        <h4
                            class="text-xs md:text-sm uppercase font-semibold font-montserrat tracking-widest text-primary">
                            Wedding Rings
                        </h4>
                    </div>
                </a>
                ...
                <!-- Second Image Card -->
                <a href="{{ route('diamond-necklaces') }}" class="block">
                    <div class="flex flex-col items-start">
                ...
                <!-- Third Image Card -->
                <a href="{{ route('earrings') }}" class="block">
                    <div class="flex flex-col items-start">
                ...
                <!-- Second Row -->
                <!-- Fourth Image Card -->
                <a href="{{ route('bracelets') }}" class="block">
                    <div class="flex flex-col items-start">
                ...
                <!-- Fifth Image Card -->
                <a href="{{ route('pendants') }}" class="block">
                    <div class="flex flex-col items-start">
                ...
                <!-- Sixth Image Card -->
                <button onclick="openCustomForm()" class="w-full">
                    <div class="flex flex-col items-start">
        ...
        <div id="customFormModal"
            ...
            <div class="bg-white rounded-lg p-8 w-full max-w-2xl relative">
                <button onclick="closeCustomForm()" class="absolute top-2 right-2 text-black text-2xl">&times;</button>

                <h2 class="text-2xl font-bold mb-6 text-center">Custom Setting Request</h2>

                <form method="POST" action="{{ route('custom-setting.request') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input type="text" name="reference_url" placeholder="Reference URL"
                        class="border p-2 rounded w-full my-4">

                    <input type="file" name="photos[]" multiple accept="image/*"
                        class="border p-2 rounded w-full mb-2">
                    <p class="text-xs text-gray-500 mb-4">Note: Maximum 3 photos allowed, size &lt; 2 MB each.</p>
                    ...
                    <textarea name="details"
                        ...
                        class="border p-2 rounded w-full mb-4" rows="4" required></textarea>

                    <button type="submit"
                        class="bg-primary text-white py-2 px-4 rounded w-full hover:bg-primary-dark">Submit</button>
                </form>
            </div>
        </div>
        ...
        <script>
            function openCustomForm() {
                document.getElementById('customFormModal').classList.remove('hidden');
            }

            function closeCustomForm() {
                document.getElementById('customFormModal').classList.add('hidden');
            }
        </script>
        ...
        <section class="py-7 xl:py-10 2xl:py-16">
            <div class="container mx-auto px-6 py-8">
                <h2 class="text-2xl md:text-3xl lg:text-40px font-literata font-medium text-center text-primary">Engagement
                    Rings By Style</h2>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-7 lg:gap-9 mx-4 md:mx-4 lg:mx-auto lg:w-5/6">
                ...
                <div class="flex flex-col items-center">
                    <a href="{{ route('solitaire') }}">
                        ...
                        <h4
                            class="text-xs md:text-sm uppercase font-semibold font-montserrat tracking-widest text-primary text-center">
                            Solitaire</h4>
                    </a>
                </div>
        ...
        <section class="relative h-[400px] mb-12">
            ...
            <div class="absolute inset-0 hidden md:block">
                <img src="/images/Lab-Grown-Color-Diamond-1-scaled-1.webp" alt="Colored Lab Diamonds"
                    class="w-full h-full object-cover">
            </div>

            <!-- Content Container -->
            <div class="container mx-auto md:pl-8 md:pr-72 lg:px-14 xl:px-24 2xl:px-44 relative h-full">
                <img src="/images/mobile-Lab-Grown-Color-Diamond.webp" alt="Colored Lab Diamonds"
                    class="w-full h-1/2 object-cover md:hidden">
                <div
                    class="flex flex-col justify-center items-center md:items-start h-4/6 md:h-full max-w-2xl bg-black md:bg-transparent">
                    ...
                    <a href="{{ route('color.diamond') }}"
                        class="inline-block bg-white text-primary font-montserrat text-sm font-semibold px-4 md:px-8 py-4 rounded-md hover:bg-black hover:border-white hover:border-2 border-2 border-white hover:text-white transition duration-300 w-fit">
        ...
        <section class="py-5 xl:py-12 bg-light-blue-3 flex flex-col items-center">
            <div class="container mx-auto px-4 py-8">
                <h2 class="text-2xl md:text-3xl lg:text-40px font-literata font-medium text-center text-primary mb-3">What
                    Our Customers Say</h2>
                <p class="text-center font-montserrat text-base md:text-lg text-primary/80 tracking-wide">We've served
                    15631+ customers worldwide and counting</p>
            </div>
            <div class="container mx-auto px-4 md:px-4 lg:px-14 xl:px-24 2xl:px-44 mb-10">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-lg h-full flex flex-col">
                        <h3 class="font-montserrat text-lg font-semibold mb-3 text-primary">Reliable, definitely recommend!
                        </h3>
                        ...
                        <div class="flex items-center mt-auto">
                            ...
                            <div>
                                <div class="flex items-center">
                                    <p
                                        class="font-montserrat font-semibold text-primary md:w-20 md:text-13px lg:w-full lg:text-sm">
                                        Anuschka Grobler</p>
                    ...
                    <!-- Review Card 2 -->
                    <div class="bg-white rounded-lg p-6 shadow-lg h-full flex flex-col">
                        <h3 class="font-montserrat text-lg font-semibold mb-3 text-primary">I had an extremely positive
                            experience…</h3>
                        <p class="font-montserrat text-sm text-primary/90 mb-6 flex-grow">
            ...
            <a href="#"
                class="flex justify-center cursor-pointer text-sm p-2 bg-primary border border-primary text-gold hover:text-primary hover:bg-white w-40 text-center transition-all duration-300">
                View All Reviews
            </a>
        </section>
            ...
            <div class="container mx-auto px-4 md:px-8 lg:px-14 xl:px-24 2xl:px-28">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-lg">
                        ...
                        <p class="text-sm text-gray-600 text-center">Get special member-only pricing and early access to
                            sales events</p>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-lg">
                        ...
                        <p class="text-sm text-gray-600 text-center">Enjoy personalized shopping assistance and priority
                            customer support</p>
                    </div>
                ...
                <div class="text-center mt-8">
                    <a href="{{ route('subscription.plans') }}"
                        class="inline-block bg-primary text-gold hover:bg-white hover:text-primary border border-primary font-montserrat text-sm font-semibold px-8 py-4 rounded-md transition duration-300">
        ...
        <section class="py-6 md:py-8 lg:py-12 2xl:py-20 bg-gray-50">
            <div class="container mx-auto px-6 md:px-20 lg:px-24 xl:px-[180px]">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 lg:gap-10 items-center justify-items-center">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-[130px] md:w-[140px] lg:w-[159px]"
                        viewBox="0 0 159 31" fill="none">
                        <path
                            d="M16.6596 5.77715C16.4256 4.88526 16.0788 4.02684 15.6278 3.2226C15.1414 2.44988 14.8505 2.23624 13.1914 2.23624H10.4232V16.6544C10.4232 19.0135 10.6732 19.3135 13.4732 19.4953V20.3862H4.58233V19.4771C7.3096 19.2953 7.55051 19.0226 7.55051 16.6362V2.23624H5.00051C3.3596 2.23624 2.88233 2.43169 2.36415 3.29079C1.93586 4.08302 1.59157 4.91786 1.33688 5.78169H0.400513C0.586876 3.89988 0.768694 1.94078 0.855058 0.327148H1.57779C2.03233 1.03624 2.35506 1.0226 3.20051 1.0226H15.0187C15.846 1.0226 16.1187 0.890785 16.5732 0.327148H17.3187C17.3187 1.69078 17.4414 3.92715 17.5914 5.69533L16.6596 5.77715Z"
                            fill="#010101" />
                        <path
                            d="M29.2641 8.59987C27.7641 8.75441 27.6278 8.86805 27.6278 10.4635V17.8226C27.6278 19.418 27.7823 19.5317 29.2641 19.668V20.3862H23.3278V19.668C24.846 19.4771 24.9641 19.418 24.9641 17.8226V14.1862H19.7732V17.8226C19.7732 19.418 19.946 19.5135 21.3869 19.668V20.3862H15.4778V19.668C16.9005 19.5135 17.1096 19.418 17.1096 17.8226V10.4635C17.1096 8.86805 16.9369 8.7135 15.4778 8.59987V7.88623H21.3869V8.59987C19.9278 8.73168 19.7732 8.86805 19.7732 10.4635V13.1908H24.9641V10.4635C24.9641 8.86805 24.7687 8.75441 23.3278 8.59987V7.88623H29.2641V8.59987Z"
                            fill="#010101" />
                        <path
.9118 26.5946C39.9748 26.7693 40.0004 26.9553 39.9869 27.1406C39.9955 27.2055 39.9955 27.2712 39.9869 27.3361L37.3915 27.3179ZM39.6369 27.0679C39.65 26.9236 39.6321 26.7782 39.5845 26.6414C39.5368 26.5046 39.4606 26.3796 39.3608 26.2746C39.2609 26.1696 39.1399 26.0871 39.0056 26.0327C38.8714 25.9782 38.7271 25.953 38.5824 25.9588C38.2833 25.9627 37.9967 26.0789 37.7795 26.2844C37.5622 26.4898 37.4302 26.7695 37.4096 27.0679H39.6369Z"
                            fill="#4D4D4D" />
                        <path d="M40.8141 24.2681H41.1278V28.8544H40.8141V24.2681Z" fill="#4D4D4D" />
                        <path
                            d="M42.2551 24.2681H42.5687V26.3999C42.6711 26.1944 42.8284 26.0213 43.0233 25.8999C43.2309 25.7711 43.4699 25.7019 43.7142 25.6999C44.0096 25.6999 44.9142 25.8317 44.9142 27.0999V28.8544H44.6005V27.1135C44.6005 26.5135 44.346 25.9772 43.6324 25.9772C43.4069 25.9839 43.1883 26.0557 43.0027 26.1839C42.8172 26.3122 42.6728 26.4914 42.5869 26.6999C42.5494 26.8048 42.5324 26.9159 42.5369 27.0272V28.8453H42.2233L42.2551 24.2681Z"
                            fill="#4D4D4D" />
                        <path
                            d="M46.4551 24.8681C46.4551 24.9368 46.4278 25.0027 46.3792 25.0513C46.3306 25.0999 46.2647 25.1272 46.196 25.1272C46.1273 25.1272 46.0614 25.0999 46.0128 25.0513C45.9642 25.0027 45.9369 24.9368 45.9369 24.8681C45.9368 24.7969 45.9641 24.7283 46.0132 24.6767C46.0623 24.6251 46.1294 24.5943 46.2005 24.5908C46.2709 24.5944 46.337 24.6254 46.3846 24.6773C46.4322 24.7292 46.4575 24.7977 46.4551 24.8681ZM46.0414 28.8545V25.7772H46.3551V28.8545H46.0414Z"
                            fill="#4D4D4D" />
        ...
        <section class="py-6 md:py-8 lg:py-12">
            <div class="container mx-auto">
                <h2 class="text-center font-medium font-montserrat text-primary text-xl md:text-3xl">Follow us on Instagram
                </h2>
            </div>
            <div class="flex items-center justify-center mt-2 md:mt-4 gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="20" height="20"
            ...
            <div class="container mx-auto mt-4 md:mt-10">
                <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
                    <div>
                        <img class="w-full h-5/6 object-cover" src="/images/instagram/Image-1.webp"
                            alt="Instagram post 1">
                    </div>
                    <div>
                        <img class="w-full h-5/6 object-cover" src="/images/instagram/Image-2.jpg"
                            alt="Instagram post 2">
                    </div>
                    <div>
                        <img class="w-full h-5/6 object-cover" src="/images/instagram/Image-3.jpg"
                            alt="Instagram post 3">
                    </div>
                    <div>
                        <img class="w-full h-5/6 object-cover" src="/images/instagram/Image-4.webp"
                            alt="Instagram post 4">
                    </div>
                    <div>
                        <img class="w-full h-5/6 object-cover" src="/images/instagram/Image-5.webp"
                            alt="Instagram post 5">
                    </div>
                    <div>
                        <img class="w-full h-5/6 object-cover" src="/images/instagram/Image-6.webp"
