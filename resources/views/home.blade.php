    ...
    <div class="bg-gray-50">
        ...
        <section class="bg-[url('/images/hero.jpg')] bg-cover bg-center h-screen flex items-center justify-center">
            <div class="text-center text-white">
                <h1 class="text-5xl font-bold mb-6">Find the Perfect Diamond</h1>
                <p class="text-xl mb-8">Discover the finest collection of loose diamonds.</p>
            ...
            <div class="container mx-auto px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="border border-gray-200 p-6 rounded-lg hover:shadow-lg transition">
                        <img src="/images/diamond1.jpg" alt="Diamond 1" class="w-full h-64 object-cover mb-6">
