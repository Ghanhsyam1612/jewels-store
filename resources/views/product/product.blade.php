...
@section('content')
    <div class="container pt-8">
        <nav class="flex items-center text-sm font-montserrat mb-4 px-16 py-3">
        ...
        <div class="flex flex-col md:flex-row gap-5 px-16 py-6">
            <!-- Left side - Photo -->
            <div class="flex flex-col gap-8 mb-12 w-4/6">
                <!-- Thumbnail images -->
                    ...
                    <div class="flex flex-col justify-center">
                        <div class="relative flex flex-col items-center">
                            ...
                            <div class="relative w-full">
                                <img src="/images/hand-transparent-shadow.webp" alt="Hand model" class="w-full">
                                <!-- Diamond overlay with dynamic sizing -->
                                <div id="diamond-overlay" class="absolute left-[30%] top-[65%]">
            ...
            <div class="w-1/3 space-y-2">
                <!-- Product Name -->
                <h1 class="text-2xl font-semibold text-primary">The Trellis Three Stone Emerald Engagement Ring</h1>
                <!-- Product Price -->
                <h3 class="text-lg font-semibold text-primary">Starting at CA $10,000</h3>
                <!-- Product Shape -->
                <div class="flex flex-col gap-2 py-2">
                    <p class="text-sm font-semibold text-primary">Shape : <span class="font-normal">Round</span></p>
                ...
                <!-- Product Color -->
                <div class="flex flex-col gap-2 py-2">
                    <p class="text-sm font-semibold text-primary">Metal : <span class="font-normal">Platinum</span></p>
                ...
                <div class="flex justify-center">
                    <button
                        class="bg-primary font-semibold text-gold w-full px-6 py-3 hover:bg-gold hover:text-primary transition duration-300">
                        Select Your Diamond
                    </button>
                </div>
                ...
                <div class="flex justify-center">
                    <button
                        class="bg-gold font-semibold text-primary w-full px-6 py-3 hover:bg-primary hover:text-gold transition duration-300">
                ...
                <div class="flex flex-col gap-2 py-3">
                    <div class="flex flex-row items-center gap-2">
                        ...
                        <p class="text-sm text-primary flex flex-row items-center gap-1">
                    ...
                    <div class="flex flex-row items-center gap-2">
                        ...
                        <p class="text-sm text-primary">Made-to-order. Ship by Wed, Jan 29</p>
                    </div>
                    <div class="flex flex-row items-center gap-2">
                        <img src="{{ asset('Shape/security.svg') }}" alt="Diamond" class="w-5 h-5">
                        <p class="text-sm text-primary underline">Lifetime warranty and value guarantee</p>
                    </div>
                    <div class="flex flex-row items-center gap-2">
                        <img src="{{ asset('Shape/truck.svg') }}" alt="Diamond" class="w-5 h-5">
                        <a href="/shipping-policy" class="text-sm text-primary underline">Shipping Policy</a>
                    </div>
                    <div class="flex flex-row items-center gap-2">
                        <img src="{{ asset('Shape/return.svg') }}" alt="Diamond" class="w-5 h-5">
                        <a href="/return-policy" class="text-sm text-primary underline">Return Policy</a>
                    </div>
                </div>
                <!-- Need More Time To Think? -->
                <div class="flex flex-col gap-1 py-3">
                    <p class="text-xl text-primary uppercase font-medium">Need more time to think?</p>
                    <p class="text-sm text-primary">Email this piece to yourself or drop a hint.</p>
                    <div class="flex flex-row items-center gap-2 mt-2">
                        <input type="email" placeholder="Enter your email"
                            class="w-full px-4 py-2 border border-gray-300">
                        <button class="bg-primary text-gold font-medium px-4 py-2">Submit</button>
                    </div>
                    <div class="flex flex-row items-center gap-2 mt-2">
                        ...
                        <p class="text-base text-gray-500">
                            Accept
                            <a href="/privacy-policy" class="text-base text-primary underline">Privacy Policy</a>
                        </p>
                    </div>
                </div>
                <!-- Product Description -->
                <div class="flex flex-col gap-2 py-3">
                    <p class="text-lg text-primary font-semibold">The Trellis Three Stone Details</p>
                    <p class="text-base text-primary font-semibold">The Trellis Three Stone three-stone ring in platinum
                        with a emerald diamond</p>
                    <p class="text-sm text-primary leading-6">
                    ...
                    <p class="text-sm text-primary font-medium">Band width : <span class="font-normal">2.2mm</span></p>
                    <p class="text-sm text-primary font-medium">Band depth : <span class="font-normal">1.6mm</span></p>
                    <p class="text-sm text-primary font-medium">Setting height : <span class="font-normal">6.5mm</span>
                    </p>
                    <p class="text-sm text-primary font-medium">Gold/Platinum metal weight : <span
                            class="font-normal">6.17g (size 6)</span></p>
                    <p class="text-sm text-primary font-medium">Pavé carat weight : <span
                            class="font-normal">0.17ctw</span></p>
                    <p class="text-sm text-primary font-medium">Shown with : <span class="font-normal">1.5ct</span></p>
                    <a href="#" class="text-sm text-primary underline">For precise weight please see tolerance
                        specs.</a>
                </div>
            </div>
        </div>
        ...
        <!-- Related Products -->
        <div class="flex flex-col items-center gap-2 py-12 px-16">
            <p class="text-2xl text-primary font-semibold ">Explore Engagement Rings</p>
            <div class="grid grid-cols-4 gap-2 py-2">
                <div class="flex flex-col">
                    <img src="{{ asset('images/1.jpg') }}" alt="Diamond" class="w-full h-full mb-2">
                    <p class="text-base text-primary font-semibold">The Twist Band</p>
                    <p class="text-sm text-primary">$800+</p>
                </div>
                <div class="flex flex-col">
                    <img src="{{ asset('images/2.jpg') }}" alt="Diamond" class="w-full h-full mb-2">
                    <p class="text-base text-primary font-semibold">The Petal Crown Band</p>
                    <p class="text-sm text-primary">$800+</p>
                </div>
                <div class="flex flex-col">
                    <img src="{{ asset('images/3.jpg') }}" alt="Diamond" class="w-full h-full mb-2">
                    <p class="text-base text-primary font-semibold">The Round</p>
                    <p class="text-sm text-primary">$600+</p>
                </div>
                <div class="flex flex-col">
                    <img src="{{ asset('images/1.jpg') }}" alt="Diamond" class="w-full h-full mb-2">
                    <p class="text-base text-primary font-semibold">The Eternity Band</p>
                    <p class="text-sm text-primary">$900+</p>
                </div>
            </div>
        </div>

        <div class="flex flex-col gap-2 py-12 px-16">
            <img src="{{ asset('images/custom-jewellery.png') }}" alt="Diamond" class="relative w-full h-full mb-2">
            <div class="flex flex-col items-start gap-2 py-32 absolute right-32 w-[35rem] space-y-3">
                <h1 class="text-3xl text-white text-left font-semibold">Custom Engagement Rings</h1>
                ...
                <button class="border border-white text-center text-white font-medium w-4/5 px-4 py-3">
                    Create Your Own
                </button>
            </div>
        </div>
