                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4 md:gap-2">
                    ...
                    <div
                        ...
                        <div class="mt-5 flex items-end justify-between">
                            ...
                            @php
                                $isCustomerIncrease = $customerPercentageChange >= 0;
                                $customerColorClass = $isCustomerIncrease
                                    ? 'bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500'
                                    : 'bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500';
                            @endphp

                            <span
                                class="flex items-center gap-1 rounded-full bg-success-50 py-0.5 pl-2 pr-2.5 text-sm font-medium {{ $customerColorClass }}">
                                <svg class="fill-current" width="12" height="12" viewBox="0 0 12 12" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    @if ($isCustomerIncrease)
                                        {{-- Up Arrow (Increase) --}}
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                {{ number_format($customerPercentageChange, 2) }}%
                            </span>
                        </div>
                    </div>
                    <!-- End Customer Card -->
                    ...
                    <div
                        ...
                        <div class="mt-5 flex items-end justify-between">
                            ...
                            <span
                                class="flex items-center gap-1 rounded-full py-0.5 pl-2 pr-2.5 text-sm font-medium {{ $orderColorClass }}">
                                <svg class="fill-current" width="12" height="12" viewBox="0 0 12 12" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    @if ($isOrderIncrease)
                                        {{-- Up Arrow (Increase) --}}
                    ...
                    <div
                        ...
                        <div class="mt-5 flex items-end justify-between">
                            ...
                            @php
                                $isTotalOrderIncrease = $totalOrderPercentageChange >= 0;
                                $totalOrderColorClass = $isTotalOrderIncrease
                                    ? 'bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500'
                                    : 'bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500';
                            @endphp

                            <span
                                class="flex items-center gap-1 rounded-full bg-error-50 py-0.5 pl-2 pr-2.5 text-sm font-medium {{ $totalOrderColorClass }}">
                                <svg class="fill-current" width="12" height="12" viewBox="0 0 12 12" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    @if ($isTotalOrderIncrease)
                                        {{-- Up Arrow (Increase) --}}
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M5.56462 1.62393C5.70193 1.47072 5.90135 1.37432 6.12329 1.37432C6.1236 1.37432 6.12391 1.37432 6.12422 1.37432C6.31631 1.37415 6.50845 1.44731 6.65505 1.59381L9.65514 4.5918C9.94814 4.88459 9.94831 5.35947 9.65552 5.65246C9.36273 5.94546 8.88785 5.94562 8.59486 5.65283L6.87329 3.93247L6.87329 10.125C6.87329 10.5392 6.53751 10.875 6.12329 10.875C5.70908 10.875 5.37329 10.5392 5.37329 10.125L5.37329 3.93578L3.65516 5.65282C3.36218 5.94562 2.8873 5.94547 2.5945 5.65248C2.3017 5.35949 2.30185 4.88462 2.59484 4.59182L5.56462 1.62393Z"
                                            fill="" />
                                ...
                                {{ number_format($totalOrderPercentageChange, 2) }}%
                            </span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="mt-5 flex items-end justify-between">
                            ...
                            @php
                                $isRevenueIncrease = $revenuePercentageChange >= 0;
                                $revenueColorClass = $isRevenueIncrease
                                    ? 'bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500'
                                    : 'bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500';
                            @endphp

                            <span
                                class="flex items-center gap-1 rounded-full bg-error-50 py-0.5 pl-2 pr-2.5 text-sm font-medium {{ $revenueColorClass }}">
                            ...
                            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                                <div class="relative flex items-center">
                                    ...
                                    <button class="absolute left-4 flex items-center text-gray-500 dark:text-gray-400">
                                        <svg class="fill-current w-5 h-5" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="max-w-full overflow-x-auto">
                            <div class="min-w-[1102px]">
                                ...
                                <div class="grid grid-cols-12 border-t border-gray-200 dark:border-gray-800">
                                    <!-- Order Date -->
                                    <div
                                        class="flex col-span-2 items-center border-r border-gray-200 px-4 py-3 dark:border-gray-800">
                                        <div class="flex w-full cursor-pointer items-center justify-between"
                                            @click="sortBy('order_date')">
                                            <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Order
                                                Date</p>
                                    ...
                                    <div
                                        ...
                                        <div class="flex w-full cursor-pointer items-center justify-between"
                                            ...
                                            <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Customer
                                            </p>
                                            <span class="flex flex-col gap-0.5">
                                                <!-- Same SVG icons -->
                                            </span>
                                    ...
                                    <!-- Status -->
                                    <div
                                        class="flex col-span-1 items-center border-r border-gray-200 px-4 py-3 dark:border-gray-800">
                                        <div class="flex w-full cursor-pointer items-center justify-between"
                                            @click="sortBy('status')">
                                            <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Status
                                            </p>
                                            <span class="flex flex-col gap-0.5">
                                                <!-- Same SVG icons -->
                                            </span>
                                    ...
                                    <div
                                        ...
                                        <div class="flex w-full cursor-pointer items-center justify-between"
                                            ...
                                            <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Currency
                                            </p>
                                            <span class="flex flex-col gap-0.5">
                                                <!-- Same SVG icons -->
                                            </span>
                                    ...
                                    <!-- Total Price -->
                                    <div
                                        class="flex col-span-2 items-center border-r border-gray-200 px-3 py-3 dark:border-gray-800">
                                        <div class="flex w-full cursor-pointer items-center justify-between"
                                            @click="sortBy('total_price')">
                                            <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Total
                                                Price</p>
                                            <span class="flex flex-col gap-0.5">
                                                <!-- Same SVG icons -->
                                            </span>
                                    ...
                                    <div
                                        class="flex col-span-1 items-center border-r border-gray-200 px-4 py-3 dark:border-gray-800">
                                        <div class="flex w-full cursor-pointer items-center justify-between"
                                            @click="sortBy('shipping_cost')">
                                            <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Shipping
                                                Cost</p>
                                            <span class="flex flex-col gap-0.5">
                                                <!-- Same SVG icons -->
                                            </span>
                                ...
                                @foreach ($dailyOrders as $order)
                                    <div x-data="{ checkboxToggle: false }"
                                                ...
                                                <div class="mt-1">
                                                    <label
                                                        ...
                                                        <span
                                                            ...
                                                            class="flex h-4 w-4 items-center justify-center rounded border-[1.25px]">
                                        ...
                                        <!-- Customer -->
                                        <div
                                            class="col-span-2 flex flex-col items-start border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400">
                                                {{ $order->full_name }}</p>
                                            <span
                                                class="text-xs text-gray-500 dark:text-gray-400">{{ $order->customer->email }}</span>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400">
                                                {{ $order->payments ? $order->payments->currency : 'N/A' }}
                                        </div>
                                        ...
                                        <div
                                            class="col-span-2 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400">
                                                {{ $order->currency }}{{ number_format($order->total_amount, 2) }}</p>
                                        </div>
                                        ...
                                        <div
                                            class="col-span-1 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400">
                                                {{ $order->currency }}{{ number_format($order->shipping_cost, 2) }}</p>
                                        </div>

                                        <!-- Actions -->
                                        <div class="col-span-1 flex items-center px-4 py-3">
                                            <div class="flex w-full items-center gap-2">
                                                <a href="{{ route('admin.order.view', ['order' => $order->id]) }}" class="text-purple-500 hover:underline">Open</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
