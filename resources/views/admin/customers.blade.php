...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6">
    <div class="flex flex-col gap-4 md:gap-6">
        <div class="col-span-12">
            <div class="overflow-hidden border border-gray-200 bg-white rounded-xl pt-4 dark:border-gray-800 dark:bg-white/[0.03]" x-data="customerTable()">
                ...
                <div class="mb-4 px-4">
                    <div class="relative">
                        <input type="text" x-model="search" placeholder="Search customers..." class="h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-11 pr-4 text-sm text-gray-800 shadow-sm placeholder:text-gray-400 focus:border-blue-300 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                        ...
                        <tbody>
                            <template x-for="customer in paginatedData" :key="customer.id">
                                <tr class="border-b border-gray-200 dark:border-gray-800">
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-400" x-text="customer.joined_date"></td>
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-400" x-text="customer.name"></td>
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-400" x-text="customer.email"></td>
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-400" x-text="customer.phone"></td>
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-400" x-text="customer.location"></td>
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-400" x-text="customer.total_orders"></td>
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-400" x-text="customer.total_spent"></td>
                                    <td class="px-4 py-3">
                                        <span 
                                        :class="{
                                            'rounded-full px-3 py-1 text-xs font-medium': true,
                                            'bg-green-100 text-green-700 dark:bg-green-500/15 dark:text-green-500': customer.status === 'Active',
                                            'bg-yellow-100 text-yellow-700 dark:bg-yellow-500/15 dark:text-yellow-500': customer.status === 'Pending',
                                            'bg-red-100 text-red-700 dark:bg-red-500/15 dark:text-red-500': customer.status === 'Inactive'
                                        }"
