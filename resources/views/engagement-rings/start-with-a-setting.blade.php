    ...
    <div class="container mb-10">
        ...
        <div class="my-7 px-40">
            <div class="flex border border-gray-200 rounded-sm">
                <div class="bg-light-yellow text-center w-1/6">
                ...
                <div class="w-2/6 px-0">
                    <div class="bg-light-grey-1 flex items-center justify-between py-4 px-4 h-full min-h-16">
                        <div class="flex items-center justify-center">
                            <span class="text-3xl font-montserrat font-semibold pr-4">1</span>
                            <div class="text-sm font-montserrat text-gray-400">
                                <span class="">Choose a</span><br>
                                <a href="#"
                                    class="uppercase text-gray-800 hover:text-amber-600 tracking-wide font-semibold">Setting</a>
                            </div>
                        </div>
                        <div class="">
                ...
                <div class="w-2/6 px-0">
                    <div class="flex items-center justify-between py-4 px-4 h-full min-h-16">
                        <div class="flex items-center justify-center">
                            <span class="text-3xl font-montserrat font-semibold pr-4">2</span>
                            <div class="text-sm font-montserrat text-gray-400">
                                <span class="">Choose a</span><br>
                                <a href="#"
                                    class="uppercase text-gray-800 hover:text-amber-600 tracking-wide font-semibold">Diamond</a>
                            </div>
                        </div>
                        <div class="">
                ...
                <div class="w-2/6 px-0">
                    <div class="flex items-center py-4 px-4 h-full min-h-16">
                        <div class="flex items-center justify-center">
                            ...
                            <div class="text-sm font-montserrat text-gray-400">
                                <span class="">Complete</span><br>
                                <a href="#"
                                    class="uppercase text-gray-800 hover:text-amber-600 tracking-wide font-semibold">Ring</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex items-center justify-between mx-40 py-5 border-b border-gray-600">
            <div class="flex flex-row items-center justify-between gap-5">
                ...
                <div class="relative flex items-center">
                    ...
                    <div id="styleDropdown" class="hidden absolute top-full left-0 mt-1 w-64 bg-white border border-gray-300 rounded shadow-lg z-10">
                        <div class="py-2">
                ...
                <div class="relative flex items-center">
                    ...
                    {{-- Down Arrow --}}
                    <svg id="shapeDropdownIcon" fill="#000000" height="8" width="8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 330.002 330.002" xml:space="preserve" class="cursor-pointer"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path id="XMLID_23_" d="M329.155,100.036c-2.108-6.011-7.784-10.035-14.154-10.035h-300c-6.371,0-12.046,4.024-14.154,10.035 c-2.109,6.011-0.19,12.699,4.784,16.678l150.004,120c2.739,2.191,6.055,3.287,9.37,3.287c3.316,0,6.631-1.096,9.371-3.287 l149.996-120C329.346,112.734,331.264,106.047,329.155,100.036z"></path> </g></svg>
                    {{-- Up Arrow --}}
                    <svg class="hidden" height="8" width="8" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path style="fill:#000000;" d="M503.265,330.918L270.532,144.737c-8.501-6.8-20.579-6.8-29.075,0L8.736,330.918 c-7.719,6.173-10.695,16.55-7.422,25.876c3.271,9.326,12.077,15.569,21.96,15.569h465.453c9.883,0,18.689-6.242,21.96-15.569 C513.958,347.466,510.982,337.091,503.265,330.918z"></path> </g></svg>

                    <div id="shapeDropdown" class="hidden absolute top-full left-0 mt-1 w-64 bg-white border border-gray-300 rounded shadow-lg z-10">
                        <div class="py-2">
                            <label class="flex items-center px-4 py-2 hover:bg-gray-100">
                                <input type="checkbox" class="mr-2">
                ...
                <div class="relative flex items-center">
                    ...
                    {{-- Down Arrow --}}
                    <svg id="priceDropdownIcon" fill="#000000" height="8" width="8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 330.002 330.002" xml:space="preserve" class="cursor-pointer"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path id="XMLID_23_" d="M329.155,100.036c-2.108-6.011-7.784-10.035-14.154-10.035h-300c-6.371,0-12.046,4.024-14.154,10.035 c-2.109,6.011-0.19,12.699,4.784,16.678l150.004,120c2.739,2.191,6.055,3.287,9.37,3.287c3.316,0,6.631-1.096,9.371-3.287 l149.996-120C329.346,112.734,331.264,106.047,329.155,100.036z"></path> </g></svg>
                    {{-- Up Arrow --}}
                    <svg class="hidden" height="8" width="8" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path style="fill:#000000;" d="M503.265,330.918L270.532,144.737c-8.501-6.8-20.579-6.8-29.075,0L8.736,330.918 c-7.719,6.173-10.695,16.55-7.422,25.876c3.271,9.326,12.077,15.569,21.96,15.569h465.453c9.883,0,18.689-6.242,21.96-15.569 C513.958,347.466,510.982,337.091,503.265,330.918z"></path> </g></svg>

                    <div id="priceDropdown" class="hidden absolute top-full left-0 mt-1 w-64 bg-white border border-gray-300 rounded shadow-lg z-10">
                        <div class="py-4 px-4">
            ...
            <div class="relative flex items-center">
                ...
                {{-- Down Arrow --}}
                <svg id="sortDropdownIcon" fill="#000000" height="8" width="8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 330.002 330.002" xml:space="preserve" class="cursor-pointer"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path id="XMLID_23_" d="M329.155,100.036c-2.108-6.011-7.784-10.035-14.154-10.035h-300c-6.371,0-12.046,4.024-14.154,10.035 c-2.109,6.011-0.19,12.699,4.784,16.678l150.004,120c2.739,2.191,6.055,3.287,9.37,3.287c3.316,0,6.631-1.096,9.371-3.287 l149.996-120C329.346,112.734,331.264,106.047,329.155,100.036z"></path> </g></svg>
                {{-- Up Arrow --}}
                <svg class="hidden" height="8" width="8" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path style="fill:#000000;" d="M503.265,330.918L270.532,144.737c-8.501-6.8-20.579-6.8-29.075,0L8.736,330.918 c-7.719,6.173-10.695,16.55-7.422,25.876c3.271,9.326,12.077,15.569,21.96,15.569h465.453c9.883,0,18.689-6.242,21.96-15.569 C513.958,347.466,510.982,337.091,503.265,330.918z"></path> </g></svg>

                <div id="sortDropdown" class="hidden absolute top-full left-0 mt-1 w-48 bg-white border border-gray-300 rounded shadow-lg z-10">
                    <div class="py-2">
        ...
        <div class="grid grid-cols-4 mx-40 my-5 gap-6">
            ...
            <div class="flex flex-col items-center justify-center">
                <a href="/product">
                    ...
                    <h3 class="mt-3 text-sm font-montserrat font-semibold text-gray-600 px-3 h-11 text-center">Adaya Asscher Solitaire Engagement Ring</h3>
                </a>
