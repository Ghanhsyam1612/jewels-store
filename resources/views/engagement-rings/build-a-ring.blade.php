...
@section('content')
    <div class="container mb-10">
        ...
        <div class="flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 2xl:px-28 3xl:px-40 my-8 lg:my-12">
            ...
            <p class="text-sm text-primary lg:text-base font-montserrat text-center">Indication of promising relation for infinity. Engagement
        ...
        <div class="my-7 lg:px-40">
            <div class="flex rounded-sm justify-center mx-auto">
                ...
                <div class="bg-gold border border-gray-300 text-center relative hidden lg:flex lg:flex-shrink-0 lg:w-[180px]">
                ...
                <div class="relative lg:flex-1">
                    <div class="bg-slate-300 border border-gray-300 flex items-center justify-between w-[100px] md:w-48 lg:w-full py-4 px-3 lg:px-8 lg:h-full min-h-16">
                        <!-- Left arrow shape -->
                        <div class="absolute hidden lg:block left-0 top-0 h-full w-[15px] bg-slate-300 clip-path-arrow-left"></div>
                        ...
                        <div class="absolute right-[-15px] top-0 h-full w-[15px] z-10">
                            <div class="w-0 h-0 absolute
                                ...
                                border-l-[8px] border-l-slate-300
                ...
                <div class="relative lg:flex-1">
                    <div class="bg-slate-200 border-r-slate-200 border border-gray-300 flex items-center justify-between w-28 md:w-48 lg:w-full py-4 px-4 lg:px-8 lg:h-full min-h-16">
                        <!-- Left arrow shape -->
                ...
                <div class="relative lg:lg:flex-1">
                    <div class="flex items-center justify-between border border-gray-300 w-[100px] md:w-48 lg:w-full py-4 px-4 lg:px-8 lg:h-full min-h-16">
                        <!-- Left arrow shape -->
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <div class="text-10px md:text-sm lg:text-base font-montserrat text-gray-400">
                                ...
                                <a href="#" class="uppercase text-gray-800 text-10px md:text-sm lg:text-base hover:text-amber-600 tracking-wide font-semibold">Ring</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex flex-row gap-3 lg:gap-5 lg:hidden items-center justify-between px-4 lg:mx-40 py-5 border-b border-gray-600 overflow-x-auto">
            <div class="flex flex-row items-center">
                <h5 class="text-xs lg:text-sm font-montserrat font-semibold w-16">Filter By : </h5>
            </div>
            <div class="flex flex-row items-center lg:justify-between gap-3 lg:gap-5">
                <!-- Style Filter -->
                <div class="relative flex items-center lg:w-32">
                    <label class="block text-10px lg:text-13px font-montserrat font-semibold uppercase mr-3">Style</label>
                    {{-- Down Arrow --}}
                ...
                <div class="relative flex items-center w-28 lg:w-32">
                    <label class="block text-10px lg:text-13px w-full font-montserrat font-semibold uppercase mr-3">Diamond Shape</label>
                    {{-- Down Arrow --}}
                    <svg id="shapeDropdownIcon" fill="#000000" height="9" width="9" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 330.002 330.002" xml:space="preserve" class="cursor-pointer">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                ...
                <!-- Price Filter -->
                <div class="relative flex items-center lg:w-32">
                    <label class="block text-10px lg:text-13px font-montserrat font-semibold uppercase mr-3">Price</label>
                    {{-- Down Arrow --}}
            ...
            <!-- Sort By -->
            <div class="relative flex items-center lg:w-32">
                <label class="block text-10px lg:text-13px font-montserrat font-semibold uppercase w-28 mr-3">Sort By Price</label>
                {{-- Down Arrow --}}
                ...
                <div id="sortDropdown"
                    class="hidden absolute top-full left-0 mt-1 w-48 bg-white border border-gray-300 rounded shadow-lg z-50">
                    <div class="py-2">
