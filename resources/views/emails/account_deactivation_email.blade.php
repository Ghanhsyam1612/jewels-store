...
<head>
    ...
    <title>Important: Your Roaya Diamond Account Has Been Deactivated</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e0e0e0;">
        ...
        <tr>
            <td style="padding: 30px; text-align: center; background-color: #301419;">
                ...
                <h1 style="margin: 20px 0 0; font-size: 24px; color: #ffffff; font-weight: bold;">Account Deactivation Notice</h1>
            </td>
        </tr>
        <!-- Content Section -->
        <tr>
            <td style="padding: 30px;">
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">We want to inform you that your **Roaya Diamond account** has been **deactivated** due to [reason for deactivation].</p>

                <p style="font-size: 18px; color: #333333; line-height: 1.6;">If you believe this was a mistake or would like to reactivate your account, please click the button below:</p>
                ...
                <table cellpadding="0" cellspacing="0" style="margin: 30px auto;">
                    <tr>
                        <td style="background-color: #d4af37; padding: 12px 24px; border-radius: 4px; text-align: center;">
                            <a href="[Reactivation Link]" style="font-size: 16px; color: #000000; text-decoration: none; font-weight: bold;">Reactivate My Account</a>
                        </td>
                    </tr>
                </table>

                <p style="font-size: 18px; color: #333333; line-height: 1.6;">If you did request this deactivation, no further action is needed.</p>

                <p style="font-size: 18px; color: #333333; line-height: 1.6;">If you need any assistance, please reach out to us at <a href="mailto:support@roayadiamond.com" style="color: #d4af37; text-decoration: none;">support@roayadiamond.com</a>.</p>

                <p style="font-size: 18px; color: #333333; line-height: 1.6;">Thank you for being a part of Roaya Diamond. We hope to see you again soon.</p>
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #301419; color: #ffffff; font-size: 14px;">
                ...
                <p style="margin: 0;">You are receiving this email because you had an account on <a href="https://www.roayadiamond.com" style="color: #d4af37; text-decoration: none;">roayadiamond.com</a>.</p>
            </td>
        </tr>
    </table>
</body>
