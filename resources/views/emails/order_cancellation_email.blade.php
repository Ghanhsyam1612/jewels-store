...
<head>
    ...
    <title>Your Roaya Diamond Order Has Been Canceled</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e0e0e0;">
        ...
        <tr>
            <td style="padding: 30px; text-align: center; background-color: #301419;">
                ...
                <h1 style="margin: 20px 0 0; font-size: 24px; color: #ffffff; font-weight: bold;">Order Cancellation Notice</h1>
            </td>
        </tr>
        <!-- Content Section -->
        <tr>
            <td style="padding: 30px;">
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">We regret to inform you that your **order #[Order Number]** placed on **[Order Date]** has been **canceled** due to [reason for cancellation].</p>
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">We apologize for any inconvenience this may have caused. If you would like to place a new order, please visit our website:</p>

                <!-- Shop Again Button -->
                <table cellpadding="0" cellspacing="0" style="margin: 30px auto;">
                    <tr>
                        <td style="background-color: #d4af37; padding: 12px 24px; border-radius: 4px; text-align: center;">
                            <a href="https://www.roayadiamond.com" style="font-size: 16px; color: #000000; text-decoration: none; font-weight: bold;">Shop Again</a>
                        </td>
                    </tr>
                </table>

                <p style="font-size: 18px; color: #333333; line-height: 1.6;">If you have any questions, please reach out to us at <a href="mailto:support@roayadiamond.com" style="color: #d4af37; text-decoration: none;">support@roayadiamond.com</a>.</p>

                <p style="font-size: 18px; color: #333333; line-height: 1.6;">Thank you for choosing Roaya Diamond. We hope to serve you again soon.</p>
