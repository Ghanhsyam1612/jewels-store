...
<head>
    ...
    <title>Order Delivered - Roaya Diamond</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e0e0e0;">
        ...
        <tr>
            <td style="padding: 30px; text-align: center; background-color: #301419;">
                ...
                <h1 style="margin: 20px 0 0; font-size: 24px; color: #ffffff; font-weight: bold;">Your Order Has Been Delivered!</h1>
            </td>
        </tr>
        <!-- Content Section -->
        <tr>
            <td style="padding: 30px;">
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">We are delighted to inform you that your order has been successfully delivered. We hope you love your new piece from Roaya Diamond! Below are the details of your order:</p>
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">Your order was delivered to:</p>
                ...
                <!-- Feedback & Support -->
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">We’d love to hear from you! If you’re happy with your purchase, please consider leaving us a review:</p>
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">If you have any issues with your order or need assistance, please reach out to us at <a href="mailto:support@roayadiamond.com" style="color: #d4af37; text-decoration: none;">support@roayadiamond.com</a>.</p>
