...
<head>
    ...
    <title>Share Your Feedback - Roaya Diamond</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e0e0e0;">
        ...
        <tr>
            <td style="padding: 30px; text-align: center; background-color: #301419;">
                ...
                <h1 style="margin: 20px 0 0; font-size: 24px; color: #ffffff; font-weight: bold;">We Value Your Feedback!</h1>
            </td>
        </tr>
        <!-- Content Section -->
        <tr>
            <td style="padding: 30px;">
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">We hope you are enjoying your **[Product Name]**! Your opinion matters to us, and we would love to hear about your experience.</p>
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">Your review will help us continue to provide the highest quality jewelry and service.</p>

                <!-- Leave a Review Button -->
                <table cellpadding="0" cellspacing="0" style="margin: 30px auto;">
                    <tr>
                        <td style="background-color: #d4af37; padding: 12px 24px; border-radius: 4px; text-align: center;">
                            <a href="[Review Link]" style="font-size: 16px; color: #000000; text-decoration: none; font-weight: bold;">Leave a Review</a>
                        </td>
                    </tr>
                </table>

                <p style="font-size: 18px; color: #333333; line-height: 1.6;">As a token of appreciation, you will receive **[Discount Offer or Reward]** for your next purchase after submitting your review.</p>

                <p style="font-size: 18px; color: #333333; line-height: 1.6;">If you have any questions, feel free to reach out at <a href="mailto:support@roayadiamond.com" style="color: #d4af37; text-decoration: none;">support@roayadiamond.com</a>.</p>

                <p style="font-size: 18px; color: #333333; line-height: 1.6;">Thank you for choosing Roaya Diamond. We appreciate your support!</p>
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #301419; color: #ffffff; font-size: 14px;">
                ...
                <p style="margin: 0;">You are receiving this email because you recently made a purchase on <a href="https://www.roayadiamond.com" style="color: #d4af37; text-decoration: none;">roayadiamond.com</a>.</p>
            </td>
        </tr>
    </table>
</body>
