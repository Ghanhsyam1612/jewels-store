                ...
                <td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="640" role="presentation" bgcolor="#FFFFFF" class="table-container ">
                        <tbody>
                            <tr>
                                <td align="center">
                                    <img src="assets/shop-order-icon.png" alt="Section Image" width="120" height="120" class="alert-icon">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" align="center" width="640" style="width: 640px; min-width: 640px;" role="presentation" bgcolor="#f7f8fb">
                        <tr>
                            <td align="center" style="color:#45535C;padding:20px 40px 0 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:800;font-size:28px;-webkit-font-smoothing:antialiased;line-height:1.2;" class="table-container mobile-title">
                                ...
                                <td style="padding:0 40px;">
                                    <table cellpadding="0" cellspacing="0" border="0" align="left" width="270" role="presentation" class="table-container">
                                        <tbody>
                                            <tr>
                                                <td align="left">
                                                    <img src="assets/top-section-bg-04.jpg" alt="Product Image" width="275">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" style="line-height:20px;min-height:20px;">
                                            ...
                                            <tr>
                                                <td align="left" valign="top" style="padding:0 0 0 0;color: #45535C; font-family: 'Lato', Arial, Helvetica, sans-serif; font-size:18px; line-height: 22px;font-weight:bold;text-align: left;" class="indent-container">
                                                    <a href="#" style="color: #45535C; font-family: 'Lato', Arial, Helvetica, sans-serif; font-size:18px; line-height: 22px;font-weight:bold;text-align: left;text-decoration:none;"> Nam libero est eligendi optio cumque nihil </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="40" style="line-height:40px;min-height:40px;">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" align="right" width="270" role="presentation" class="table-container">
                                        <tbody>
                                            <tr>
                                                <td align="left">
                                                    <img src="assets/top-section-bg-03.jpg" alt="Product Image" width="275">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" style="line-height:20px;min-height:20px;">
                                ...
                                <td align="left">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" align="left" width="500" role="presentation" class="post-footer-container">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="color:#444444; font-size:13px; line-height:22px; text-align:left;border:none;font-weight:normal;padding:0 0 0 40px;">
                                                    MailerSend is a transactional email service that’s designed to help you work faster and smarter! Scale quickly with flexible payment plans, while advanced infrastructure ensures your emails get delivered. <a href="https://www.mailersend.com/" target="_blank" style="text-decoration:underline; color:#4f48e0;font-weight:bold;">Learn More About MailerSend</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" style="line-height:20px;min-height:20px;">
