...
<head>
    ...
    <title>Don't Miss Out on Your Roaya Diamond Items!</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e0e0e0;">
        ...
        <tr>
            <td style="padding: 30px; text-align: center; background-color: #301419;">
                ...
                <h1 style="margin: 20px 0 0; font-size: 24px; color: #ffffff; font-weight: bold;">You Left Something Sparkling!</h1>
            </td>
        </tr>
        <!-- Content Section -->
        <tr>
            <td style="padding: 30px;">
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">We noticed you left some beautiful pieces in your cart! These exclusive items are waiting for you, but they may not be available for long.</p>
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">We’d love to see you complete your purchase! As a special thank you, enjoy **10% off** your order with the code: <strong style="color: #d4af37;">SPARKLE10</strong> (Expires in 24 hours).</p>

                <!-- Checkout Button -->
                <table cellpadding="0" cellspacing="0" style="margin: 30px auto;">
                    <tr>
                        <td style="background-color: #d4af37; padding: 12px 24px; border-radius: 4px; text-align: center;">
                            <a href="[Cart Link]" style="font-size: 16px; color: #000000; text-decoration: none; font-weight: bold;">Return to Your Cart</a>
                        </td>
                    </tr>
                </table>
                ...
                <p style="font-size: 18px; color: #333333; line-height: 1.6;">Your perfect piece is waiting for you!</p>
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #301419; color: #ffffff; font-size: 14px;">
                ...
                <p style="margin: 0;">You are receiving this email because you added items to your cart on <a href="https://www.roayadiamond.com" style="color: #d4af37; text-decoration: none;">roayadiamond.com</a>.</p>
            </td>
        </tr>
    </table>
</body>
