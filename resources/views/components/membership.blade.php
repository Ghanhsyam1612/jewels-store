        ...
        <div class="2xl:max-w-5xl mx-auto -mt-10 pb-10 2xl:-mt-14 2xl:pb-16 overflow-hidden">
            <div class="relative aspect-video">
                ...
                <div class="absolute inset-0">
                    <iframe class="w-full h-full rounded-lg shadow-lg" src="{{ asset('videos/membership_video_1.mp4') }}" frameborder="0" allowfullscreen></iframe>
                </div>
            </div> 
        </div>
    </div>
    ...
    <div class="mx-auto px-4 md:px-16 2xl:px-40 py-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center">
                ...
                <div class="mb-4 cursor-pointer hover:scale-105 transition-transform duration-300">
                    <img src="{{ asset('images/Episode 1.png') }}" class="h-36 2xl:h-60 w-full rounded-lg shadow-lg" alt="Episode 1">
                </div>
            ...
            <div class="text-center">
                ...
                <div class="mb-4 relative cursor-pointer hover:scale-105 transition-transform duration-300" onclick="window.location.href = '{{ url('/subscription-plan') }}'">
                    <img src="{{ asset('images/Episode 2.png') }}" class="h-36 2xl:h-60 w-full rounded-lg shadow-lg" alt="Episode 2">
                    <div class="absolute inset-0 flex items-center justify-center bg-sage bg-opacity-50 rounded-lg">
            ...
            <div class="text-center">
                ...
                <div class="mb-4 relative cursor-pointer hover:scale-105 transition-transform duration-300" onclick="window.location.href = '{{ url('/subscription-plan') }}'">
                    <img src="{{ asset('images/Episode 3.png') }}" class="h-36 2xl:h-60 w-full rounded-lg shadow-lg" alt="Episode 3">
                    <div class="absolute inset-0 flex items-center justify-center bg-sage bg-opacity-50 rounded-lg">
                        <svg class="w-16 h-16 text-pitch" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
                        </svg>
