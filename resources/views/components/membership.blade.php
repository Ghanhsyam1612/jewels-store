...
@section('content')
    ...
    <section class="bg-white font-sans">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h2 class="text-3xl font-serif font-medium text-primary text-center mb-6">Exclusive Membership Tiers</h2>
            <!-- Billing Toggle -->
            <div class="flex justify-center items-center mb-12 gap-4">
                ...
                <span class="text-gray-600 font-medium yearly-label">Yearly</span>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Basic Tier -->
                <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col h-full">
                    <div class="mb-8">
                        <h3 class="text-xl font-medium text-primary mb-2">Basic Membership</h3>
                        <p class="text-4xl font-bold text-primary mb-2"><span class="price-display" data-monthly="9.99" data-yearly="99">$99</span><span class="text-lg text-gray-500 font-normal cycle-text">/year</span></p>
                        <p class="text-gray-500 text-sm">Begin your luxury jewelry journey</p>
                    </div>
                    <ul class="mb-8 flex-grow">
                        <li class="flex items-center mb-3">
                            ...
                            <span class="text-gray-600">Basic Jewelry Cleaning</span>
                        </li>
                        <li class="flex items-center mb-3">
                            <svg class="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-gray-600">5% Off on All Purchases</span>
                        </li>
                        <li class="flex items-center mb-3">
                            <svg class="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-gray-600">Member-Only Events</span>
                        </li>
                    </ul>
                    <div>
                        <button id="basicBtn" class="w-full py-3 bg-purple-100 text-primary rounded-lg font-medium hover:bg-purple-200 transition duration-300">Join Basic Membership</button>
                    </div>
                </div>

                <!-- Premium Tier -->
                <div class="bg-primary p-8 rounded-xl shadow-2xl transform scale-105 border-4 border-purple-200 flex flex-col h-full relative">
                    <div class="absolute -top-4 left-0 right-0 flex justify-center">
                        <span class="bg-white text-primary px-4 py-1 rounded-full text-sm font-medium">MOST POPULAR</span>
                    </div>
                    <div class="mb-8">
                        <h3 class="text-xl font-medium text-white mb-2">Premium Membership</h3>
                        <p class="text-4xl font-bold text-white mb-2"><span class="price-display" data-monthly="19.99" data-yearly="199">$199</span><span class="text-lg text-purple-200 font-normal cycle-text">/year</span></p>
                        <p class="text-purple-200 text-sm">VIP access to exclusive collections</p>
                    </div>
                    <ul class="mb-8 flex-grow">
                        <li class="flex items-center mb-3 text-white">
                            ...
                            <span>Priority Access to New Collections</span>
                        </li>
                        <li class="flex items-center mb-3 text-white">
                            <svg class="w-5 h-5 text-purple-300 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        ...
                        <li class="flex items-center mb-3 text-white">
                            ...
                            <span>Complimentary Jewelry Cleaning</span>
                        </li>
                        <li class="flex items-center mb-3 text-white">
                            <svg class="w-5 h-5 text-purple-300 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span>Private Shopping Events</span>
                        </li>
                    </ul>
                    <div>
                        <button id="premiumBtn" class="w-full py-3 bg-white text-primary rounded-lg font-medium hover:bg-purple-50 transition duration-300">Join Premium Membership</button>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col h-full">
                    <div class="mb-8">
                        <h3 class="text-xl font-medium text-primary mb-2">Elite Membership</h3>
                        <p class="text-4xl font-bold text-primary mb-2"><span class="price-display" data-monthly="49.99" data-yearly="499">$499</span><span class="text-lg text-gray-500 font-normal cycle-text">/year</span></p>
                        <p class="text-gray-500 text-sm">Ultimate luxury experience</p>
                    </div>
                    <ul class="mb-8 flex-grow">
                        <li class="flex items-center mb-3">
                            <svg class="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-600">All Premium Features</span>
                        </li>
                        <li class="flex items-center mb-3">
                            <svg class="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-gray-600">25% Off on All Purchases</span>
                        </li>
                        <li class="flex items-center mb-3">
                            <svg class="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-gray-600">Personal Jewelry Consultant</span>
                        </li>
                    </ul>
                    <div>
                        <button id="eliteBtn" class="w-full py-3 bg-purple-100 text-primary rounded-lg font-medium hover:bg-purple-200 transition duration-300">Join Elite Membership</button>
                    </div>
                </div>
            </div>
        </div>
