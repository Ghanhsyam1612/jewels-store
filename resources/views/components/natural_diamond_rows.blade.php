                ...
                <table class="w-full">
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            {{ $diamond->length }} x {{ $diamond->width }} x {{ $diamond->height }} mm
                            <br>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="font-montserrat font-semibold text-gray-600 uppercase py-2">{{ $diamond->ratio }}</td>
                        </tr>
                        <tr>
                            <td class="font-montserrat text-base text-gray-500 uppercase w-40 py-2">Inscription</td>
                            <td class="font-montserrat font-semibold text-gray-600 uppercase py-2">{{ $diamond->inscription }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
