...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto md:px-6 lg:px-8 xl:px-36">
        ...
        <div class="flex flex-col md:flex-row gap-8 mb-10">
            <div class="w-full md:hidden flex items-start justify-center">
            ...
            <div class="w-full md:w-1/2 space-y-6">
                <div class="space-y-4 font-montserrat text-gray-600">
                    <h2 class="text-xl md:text-2xl font-semibold text-gray-900 font-montserrat">
            ...
            <!-- Right Image -->
            <div class="hidden md:block md:w-1/2 items-start justify-start">
                <img src="/images/manufacturing.webp" alt="About Us" class="max-w-full h-auto object-cover">
            </div>
        </div>
        ...
        <div>
            <h2 class="text-center text-xl md:text-2xl font-medium text-gray-900 font-montserrat mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 class="text-lg md:text-xl font-semibold text-gray-900 font-montserrat">Own Manufacturing Unit</h3>
                    <p class="text-sm md:text-base text-gray-600 font-montserrat">
                ...
                <div class="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 class="text-lg md:text-xl font-semibold text-gray-900 font-montserrat">Lowest Prices</h3>
                    <p class="text-sm md:text-base text-gray-600 font-montserrat">
                ...
                <div class="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 class="text-lg md:text-xl font-semibold text-gray-900 font-montserrat">Secure Shopping</h3>
                    <p class="text-sm md:text-base text-gray-600 font-montserrat">
