    ...
    <div class="w-full mx-auto px-4 lg:px-6 xl:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
            ...
            <div class="lg:col-span-2">
                <h3 class="text-lg font-montserrat font-semibold mb-6" style="color: rgb(240,186,64);">CONNECT WITH US</h3>
                ...
                {{-- <div class="bg-white w-48 p-3 rounded-lg mb-6">
                    <img src="{{ asset('Shape/gr1.svg') }}" alt="Google Rating" class="w-full h-auto">
                </div> --}}
                <div class="space-y-2">
                    <p class="text-sm font-montserrat" style="color: rgb(240,186,64);">+1 646-288-0810</p>
                    <p class="text-sm font-montserrat" style="color: rgb(240,186,64);">55W 47th St., Suite #790</p>
                    <p class="text-sm font-montserrat" style="color: rgb(240,186,64);">New York, NY-10036, USA</p>
                </div>
            </div>
        ...
        <div class="border-t border-gray-700 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-sm font-montserrat" style="color: rgb(240,186,64);">&copy; {{ date('Y') }} Roaya Diamond. All Rights Reserved.</p>
                {{-- <div class="flex items-center space-x-4">
                    <img src="{{ asset('Card/visa.png') }}" alt="Visa" class="h-8">
                    <img src="{{ asset('Card/mastercard.png') }}" alt="Mastercard" class="h-8">
                    <img src="{{ asset('Card/amex.png') }}" alt="American Express" class="h-8">
                    <img src="{{ asset('Card/discover.png') }}" alt="Discover" class="h-8">
                </div> --}}
            </div>
        </div>
    </div>
