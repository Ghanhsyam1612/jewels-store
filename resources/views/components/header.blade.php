<header class="bg-primary font-montserrat">
    ...
    <div id="sticky-header" class="mx-auto flex items-center justify-between py-4 px-6 bg-primary max-w-screen-3xl">
        ...
        <nav class="hidden lg:flex space-x-6 z-50">
            ...
            <div class="relative group">
                <a href="{{ route('inventory') }}"
                    ...
                    style="color: rgb(240,186,64);">SELECT YOUR DIAMOND
                    <span class="ml-1">
                ...
                <!-- Dropdown menu -->
                <div
                    class="absolute left-1/2 -translate-x-1/2 mt-2 w-56 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-10">
                    <div class="py-2">
                        <!-- Natural Diamond -->
                        ...
                        <div class="group/lab relative">
                            <a href="#"
                                class="block px-4 py-2 text-12px leading-[19px] font-sm text-primary hover:font-semibold font-medium transition-all duration-200">Lab
                                Diamond</a>

                            <!-- Lab Diamond submenu -->
                            <div
                                class="absolute left-full top-0 w-56 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover/lab:opacity-100 group-hover/lab:visible transition-all duration-300">
                                <div class="py-2">
                                    <a href="{{ route('inventory') }}"
                                        class="block px-4 py-2 text-12px leading-[19px] font-sm text-primary hover:font-semibold font-medium transition-all duration-200">Solitaire
                                        Diamonds</a>
                                    <a href="{{ route('fancy-shapes-diamonds') }}"
                                        class="block px-4 py-2 text-12px leading-[19px] font-sm text-primary hover:font-semibold font-medium transition-all duration-200">Fancy
                                        Shapes Diamonds</a>
                                    <a href="/fancy-color-diamonds"
                                        class="block px-4 py-2 text-12px leading-[19px] font-sm text-primary hover:font-semibold font-medium transition-all duration-200">Fancy
                                        Color Diamonds</a>
                                    <a href="{{ route('color-melee-diamonds') }}"
                                        class="block px-4 py-2 text-12px leading-[19px] font-sm text-primary hover:font-semibold font-medium transition-all duration-200">Color
                                        Melee Diamonds</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="relative group">
                <a href="#"
                    class="text-gold hover:text-white flex items-center font-montserrat text-12px font-semibold leading-[30px] tracking-wide transition-all"
                    style="color: rgb(240,186,64);">ENGAGEMENT RINGS
                    <span class="ml-1">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 10L12 15L17 10" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <!-- Dropdown menu -->
                <div
                    class="absolute left-52 -translate-x-1/2 transform mt-2 lg:w-[900px] xl:w-[1000px] bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                    <div class="grid grid-cols-3 py-6">
                        <!-- Column 1 -->
                        <div class="border-r border-gray-200">
                            <h3 class="font-semibold text-primary text-12px leading-[19px] mb-2 pl-6">Create Your
                                Diamond Ring</h3>
                            <div class="space-y-2">
                                <a href="{{ route('build-a-ring') }}"
                                    class="block text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-6">Start
                                    With A Setting</a>
                                {{-- <a href="#" class="block text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-6">Bespoke Jewellery</a>
                                <a href="#" class="block text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-6">Custom Engagement Ring</a> --}}
                            </div>
                        </div>
                        <!-- Column 2 -->
                        <div class="border-r border-gray-200">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <a href="{{ route('solitaire') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3 group">
                                    <img src="{{ asset('images/style-shape/Solitaire.png') }}" alt="Solitaire"
                                        class="!w-9 text-gray-500" style="width: 36px;">
                                    <span class="text-primary text-xs">Solitaire</span>
                                </a>
                                {{-- Halo --}}
                                <a href="{{ route('halo') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('images/style-shape/Halo.png') }}" alt="Halo"
                                        class="!w-9 text-gray-500" style="width: 36px;">
                                ...
                                <a href="{{ route('diamond-band') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('images/style-shape/Diamond Band.png') }}" alt="Diamond Band"
                                        class="!w-9 text-gray-500" style="width: 36px;">
                                ...
                                <a href="{{ route('hidden-halo') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('images/style-shape/Hidden Halo.png') }}" alt="Hidden Halo"
                                        class="!w-9 text-gray-500" style="width: 36px;">
                                    <span class="text-primary text-xs">Hidden Halo</span>
                                </a>
                                {{-- Three Stone --}}
                                <a href="{{ route('three-stone') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pt-1 pl-3">
                                    <img src="{{ asset('images/style-shape/Three Stone.png') }}" alt="Three Stone"
                                        class="!w-9 text-gray-500" style="width: 36px;">
                                ...
                                <a href="{{ route('bezel') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pt-1 pl-3">
                                    <img src="{{ asset('images/style-shape/Bezel.png') }}" alt="Bezel"
                                        class="!w-9 text-gray-500" style="width: 36px;">
                                    <span class="text-primary text-xs">Bezel</span>
                                </a>
                                {{-- Cluster --}}
                                <a href="{{ route('cluster') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('images/style-shape/Cluster.png') }}" alt="Cluster"
                                        class="!w-9 text-gray-500" style="width: 36px;">
                                ...
                                <a href="{{ route('dainty') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('images/style-shape/Dainty.png') }}" alt="Dainty"
                                        class="!w-9 text-gray-500" style="width: 36px;">
                                ...
                                <a href="{{ route('unique') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('images/style-shape/Unique.png') }}" alt="Unique"
                                        class="!w-9 text-gray-500" style="width: 36px;">
                                ...
                                <a href="{{ route('vintage-inspired') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('images/style-shape/Vintage Rings.png') }}"
                                        alt="Vintage Rings" class="!w-9 text-gray-500" style="width: 36px;">
                        ...
                        <!-- Column 3 -->
                        <div>
                            <h3 class="font-semibold text-primary text-12px leading-[19px] mb-2 pl-3">Shop By Shape
                            </h3>
                            <div class="grid grid-cols-2 gap-2">
                                {{-- Round --}}
                                <a href="#"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('Svg/Round.svg') }}" alt="Round"
                                ...
                                <a href="#"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('Svg/Princess.svg') }}" alt="Princess"
                                        class="w-5 text-gray-500">
                                ...
                                <a href="#"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('Svg/Emerald.svg') }}" alt="Solitaire"
                                        class="w-5 text-gray-500">
                                ...
                                <a href="#"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('Svg/Asscher.svg') }}" alt="Asscher"
                                        class="w-5 text-gray-500">
                                ...
                                <a href="#"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('Svg/Marquise.svg') }}" alt="Marquise"
                                        class="w-5 text-gray-500">
                                ...
                                <a href="#"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('Svg/Cushion.svg') }}" alt="Cushion"
                                        class="w-5 text-gray-500">
                                ...
                                <a href="#"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 py-1 pl-3">
                                    <img src="{{ asset('Svg/Radiant.svg') }}" alt="Radiant"
                                        class="w-5 text-gray-500">
            ...
            <div class="relative group">
                <a href="#"
                    class="text-gold hover:text-white flex items-center font-montserrat text-12px font-semibold leading-[30px] tracking-wide transition-all"
                    style="color: rgb(240,186,64);">FINE JEWELRY
                    <span class="ml-1">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 10L12 15L17 10" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <!-- Dropdown menu -->
                <div
                    class="absolute lg:left-12 xl:left-52 -translate-x-1/2 transform mt-2 lg:w-[900px] xl:w-[1000px] bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-10">
                    <div class="grid grid-cols-4 py-6">
                        <!-- Column 1 -->
                        <div class="border-r border-gray-200">
                            <a href="{{ route('earrings') }}"
                                class="font-semibold text-primary text-12px leading-[19px] mb-2 pl-3">Earrings</a>
                            <div class="space-y-2">
                                <a href="{{ route('stud-earrings') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Stud Earrings.svg') }}" alt="Stud Earrings"
                                        class="w-8 text-gray-500">
                                    <span class="text-primary text-xs">Stud Earrings</span>
                                </a>
                                <a href="{{ route('hoops-and-drops') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Hoops and Drops Earrings.svg') }}" alt="Stud Earrings"
                                        class="w-8 text-gray-500">
                                    <span class="text-primary text-xs">Hoops and Drops Earrings</span>
                                </a>
                                <a href="{{ route('halo-earrings') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Halo Earrings.svg') }}" alt="Stud Earrings"
                                        class="w-8 text-gray-500">
                                    <span class="text-primary text-xs">Halo Earrings</span>
                                </a>
                                <a href="{{ route('cluster') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Cluster Earrings.svg') }}" alt="Stud Earrings"
                                        class="w-8 text-gray-500">
                        ...
                        <!-- Column 2 -->
                        <div class="border-r border-gray-200">
                            <a href="{{ route('wedding-rings') }}"
                                class="font-semibold text-primary text-12px leading-[19px] mb-2 pl-3">Wedding Rings</a>
                            <div class="space-y-2">
                                <a href="{{ route('diamond') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Diamond Rings.svg') }}" alt="Diamond Rings"
                                        class="w-8 text-gray-500">
                                    <span class="text-primary text-xs">Diamond Rings</span>
                                </a>
                                <a href="{{ route('anniversary') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Anniversary Rings.svg') }}" alt="Anniversary Rings"
                                        class="w-8 text-gray-500">
                                    <span class="text-primary text-xs">Anniversary Rings</span>
                                </a>
                                <a href="{{ route('eternity') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Eternity Rings.svg') }}" alt="Eternity Rings"
                                        class="w-8 text-gray-500">
                                    <span class="text-primary text-xs">Eternity Rings</span>
                                </a>
                                <a href="{{ route('stackable') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Stackable Rings.svg') }}" alt="Stackable Rings"
                                        class="w-8 text-gray-500">
                        ...
                        <!-- Column 3 -->
                        <div class="border-r border-gray-200">
                            <a href="{{ route('pendants') }}"
                                class="font-semibold text-primary text-12px leading-[19px] mb-2 pl-3">Pendants</a>
                            <div class="space-y-2">
                                <a href="{{ route('solitaire-pendants') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Solitaire Pendants.svg') }}" alt="Solitaire Pendants"
                                        class="w-8 text-gray-500">
                                    <span class="text-primary text-xs">Solitaire Pendants</span>
                                </a>
                                <a href="{{ route('halo-pendants') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Halo Pendants.svg') }}" alt="Halo Pendants"
                                        class="w-8 text-gray-500">
                                    <span class="text-primary text-xs">Halo Pendants</span>
                                </a>
                                <a href="{{ route('diamond-pendants') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/Diamond Pendant.svg') }}" alt="Diamond Pendants"
                                        class="w-8 text-gray-500">
                                    <span class="text-primary text-xs">Diamond Pendants</span>
                                </a>
                                <a href="{{ route('chains') }}"
                                    class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-semibold transition-all duration-200 pl-3">
                                    <img src="{{ asset('Svg/NecklaceIcon.svg') }}" alt="Chains"
                                        class="w-8 text-gray-500">
                        ...
                        <div>
                            <div class="space-y-4">
                                <!-- First Row -->
                                <div>
                                    <a href="{{ route('bracelets') }}"
                                        class="font-semibold text-primary text-12px leading-[19px] mb-2 pl-3">Bracelets</a>
                                    <div class="space-y-2">
                                        <a href="{{ route('tennis-bracelets') }}"
                                            class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                            <img src="{{ asset('Svg/Tennis Bracelets.svg') }}" alt="Tennis Bracelets"
                                                class="w-8 text-gray-500">
                                            <span class="text-primary text-xs">Tennis Bracelets</span>
                                        </a>
                                        <a href="{{ route('solitaire-bracelets') }}"
                                            class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                            <img src="{{ asset('Svg/Solitaire Braclates.svg') }}"
                                                alt="Solitaire Bracelets" class="w-8 text-gray-500">
                                ...
                                <!-- Second Row -->
                                <div>
                                    <a href="{{ route('diamond-necklaces') }}"
                                        class="font-semibold text-primary text-12px leading-[19px] mb-2 pl-3">Necklace</a>
                                    <div class="space-y-2">
                                        <a href="{{ route('diamond-necklaces') }}"
                                            class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                            <img src="{{ asset('Svg/NecklaceIcon.svg') }}" alt="Diamond Necklaces"
                                                class="w-8 text-gray-500">
                                            <span class="text-primary text-xs">Diamond Necklaces</span>
                                        </a>
                                        <a href="{{ route('tennis-necklaces') }}"
                                            class="flex flex-row gap-1 items-center text-12px leading-[19px] text-primary hover:font-semibold font-medium transition-all duration-200 pl-3">
                                            <img src="{{ asset('Svg/NecklaceIcon.svg') }}" alt="Tennis Necklaces"
                                                class="w-8 text-gray-500">
        ...
        <div id="mobile-menu" class="fixed inset-0 bg-primary z-50 hidden">
            ...
            <nav id="main-menu" class="flex flex-col items-start space-y-6 mt-8 mx-4">
                <button
                    ...
                    data-target="lab-diamonds-menu" style="color: rgb(240,186,64);">
                    <span class="mr-2">SELECT YOUR DIAMONDS</span>
                    {{-- Right Arrow --}}
                ...
                <button
                    class="menu-item flex justify-between items-center w-full text-gold hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    data-target="fine-jewelry-menu" style="color: rgb(240,186,64);">
                ...
                <a href="{{ route('antique.cut.diamond') }}""
                    class="flex justify-between items-center w-full text-gold hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    data-target="precious-stones-menu" style="color: rgb(240,186,64);">
                    <span class="mr-2">ANTIQUE CUT DIAMOND</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="lab-diamonds-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                <button
                    class="back-button flex flex-row items-center gap-2 text-gold hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <svg class="text-gold w-3 h-3" style="color: rgb(240,186,64);" fill="currentColor"
                ...
                <button
                    ...
                    data-target="lab-diamonds-options-menu" style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Lab Diamonds</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('natural-diamond') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Natural Diamonds</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="lab-diamonds-options-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                ...
                <a href="{{ route('inventory') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Solitaire Diamonds</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('fancy-shapes-diamonds') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Fancy Shape Diamonds</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="/fancy-color-diamonds"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Fancy Color Diamonds</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('color-melee-diamonds') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Color Melee Diamonds</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="create-diamond-ring-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                ...
                <a href="{{ route('build-a-ring') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Start with a Setting</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="shop-by-shape-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Solitaire</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Diamond Band</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Three Stone</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Cluster</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Unique</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Halo</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Hidden Halo</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Bezel</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Dainty</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Vintage Inspired</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="shop-by-style-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Round</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Emerald</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Marquise</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Oval</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Radiant</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Princess</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Asscher</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Cushion</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Pear</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="#"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Heart</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="earrings-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                ...
                <a href="{{ route('hoops-and-drops') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Hoops and Drops Earrings</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('halo-earrings') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Halo Earrings</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('cluster') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Cluster Earrings</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="wedding-rings-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                ...
                <a href="{{ route('diamond') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Diamond Rings</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('anniversary') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Anniversary Rings</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('eternity') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Eternity Rings</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('stackable') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Stackable Rings</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="pendants-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                ...
                <a href="{{ route('solitaire-pendants') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Solitaire Pendants</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('halo-pendants') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Halo Pendants</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('diamond-pendants') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Diamonds Pendants</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="bracelets-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                ...
                <a href="{{ route('tennis-bracelets') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Tennis Bracelets</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('solitaire-bracelets') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Solitaire Bracelets</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
            ...
            <nav id="necklaces-menu" class="hidden flex flex-col items-start space-y-4 mt-8 mx-4">
                ...
                <a href="{{ route('diamond-necklaces') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Diamond Necklaces</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
                ...
                <a href="{{ route('tennis-necklaces') }}"
                    class="text-gold flex justify-between items-center w-full hover:text-white font-montserrat text-12px font-semibold leading-[30px] tracking-wide"
                    style="color: rgb(240,186,64);">
                    <span class="mr-2 uppercase">Tennis Necklaces</span>
                    {{-- Right Arrow --}}
                    <svg class="text-gold w-4 h-4" style="color: rgb(240,186,64);" fill="currentColor"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004"
        ...
        <div class="flex items-center space-x-4">
            ...
            {{-- <div id="google_translate_element" class="w-full">
            </div>
            <style>
                .goog-te-gadget-simple {
                    ...
                    color: rgb(240, 186, 64) !important;
                ...
                .goog-te-gadget-simple::after {
                    ...
                    background-image: url('data:image/svg+xml;base64,') !important;
            ...
            <script type="text/javascript">
                function googleTranslateElementInit() {
                    ...
                    window.addEventListener('load', function() {
                        setTimeout(function() {
                            ...
                            if (langSelect) {
                                updateLanguageDisplay(langSelect.value);
                ...
                function updateLanguageDisplay(langCode) {
                    ...
                    const menuValue = document.querySelector('.goog-te-menu-value span:first-child');
                    if (menuValue) {
                        menuValue.textContent = langMap[langCode] || langCode.toUpperCase();
                    }
                }
            </script>
            ...
            <style>
                ...
                .goog-te-gadget-simple {
                    background-color: #301419 !important;
                    border:0 !important;
                    font-size: 10pt;
                    font-weight:800;
            ...
            <a href="/cart" class="text-gold hover:text-white relative" style="color: rgb(240,186,64);">
                ...
                <span
                    class="absolute -top-1 -right-1 bg-white text-dark-purple text-xs font-semibold rounded-full h-4 w-4 flex items-center justify-center">
                    {{ count(session('cart', [])) }}
                </span>
            </a>
        </div>
