    ...
    <div class="w-full mx-auto pt-12">
                    ...
                    <div id="shapeDropdown" class="hidden mt-4 grid grid-cols-6 gap-3 px-4 transition-all duration-300">
                        <select id="shapeSelect"
                            ...
                            @foreach (\App\Enums\AntiqueCutDiamondShapeType::cases() as $shape)
                                <option value="{{ route('antique.cut.diamond', ['shape' => $shape->value]) }}">
                                    {{ $shape->value }}</option>
                            @endforeach
                         </select>
                    </div>
                                ...
                                <div id="styleMobileDropdown"
                                    ...
                                    <div class="py-2">
                                        ...
                                        <label class="flex items-center px-4 py-2 hover:bg-gray-100">
                                            <input type="checkbox" class="mr-2 accent-black" name="lab[]"
                                                value="NON-CERT"
                                                {{ in_array('NON-CERT', $selectedLab) ? 'checked' : '' }}>
        ...
        <div class="hidden lg:grid lg:grid-cols-3 lg:gap-4 px-4 md:px-8 lg:px-12 2xl:px-28 3xl:px-40">
            ...
            <div class="flex items-center">
                ...
                <form id="priceFilterForm" action="{{ route('antique.cut.diamond') }}" method="GET"
            ...
            <div class="flex items-center">
                ...
                <form id="caratFilterForm" action="{{ route('antique.cut.diamond') }}" method="GET"
                    class="w-full">
                    <div class="flex justify-between">
                        <div>
                            <input
            ...
            <div class="flex items-center justify-center">
                ...
                <div class="w-full max-w-md">
                    <form id="cutFilterForm" action="{{ route('antique.cut.diamond') }}" method="GET">
            ...
            <div class="flex items-center">
                ...
                <div class="w-full max-w-md mt-3">
                    <form id="colorFilterForm" action="{{ route('antique.cut.diamond') }}" method="GET">
            ...
            <div class="flex items-center">
                ...
                <div class="w-full max-w-md mt-3">
                    <form id="clarityFilterForm" action="{{ route('antique.cut.diamond') }}" method="GET">
                        <div class="relative mb-3 flex items-center">
        ...
        <div class="hidden lg:flex lg:felx-row items-center gap-3 px-4 md:px-8 lg:px-12 2xl:px-28 3xl:px-40 mt-7 mb-5">
            ...
            <div class="flex flex-col lg:flex-row lg:justify-between items-start w-full">
                ...
                <div class="grid grid-cols-2 md:flex md:flex-row items-center gap-4">
                    ...
                    <div id="styleDropdownIcon"
                        ...
                        <div id="styleDropdown"
                            ...
                            <div class="py-2">
                                ...
                                <label class="flex items-center px-4 py-2 hover:bg-gray-100">
                                    <input type="checkbox" class="mr-2 accent-black" name="lab[]" value="ROAYA"
                                        {{ in_array('ROAYA', $selectedLab) ? 'checked' : '' }}>
                                    <span class="text-sm font-montserrat"> ROAYA MOISSANITE</span>
                                </label>
                            </div>
                        </div>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            methodCheckboxes.forEach(checkbox => {
                                checkbox.addEventListener("change", () => {
                                    let selectedMethods = Array.from(document.querySelectorAll(
                                            'input[name="growth_type[]"]:checked'))
                                        .map(cb => cb.value).join(',');
                    ...
                    <div id="tableDropdownIcon"
                        ...
                        <div id="tableDropdown"
                            ...
                            <div class="flex justify-between">
                                <p class="text-sm font-montserrat font-semibold px-4 py-2">Table (%)</p>
                                <button type="button" class="p-2 rounded-full" id="tableCloseBtn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"
                                        stroke-linecap="round" stroke-linejoin="round" class="text-primary">
                                        <line x1="18" y1="6" x2="6" y2="18"></line>
                            ...
                            <div class="flex items-center p-4">
                                <div class="w-full">
                                    <form id="tableForm" action="{{ route('antique.cut.diamond') }}" method="GET">
                                        <!-- Preserve existing query parameters -->
                                        @foreach (request()->except(['table_min', 'table_max']) as $key => $value)
                                            @if (is_array($value))
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    const tableCloseBtn = document.querySelector("#tableCloseBtn");

                                    function updateTableSliderColors() {
                                        const min = parseFloat(fromTableSlider.min);
                                        const max = parseFloat(toTableSlider.max);
                                        const from = parseFloat(fromTableSlider.value);
                                        const to = parseFloat(toTableSlider.value);
                                    ...
                                    function syncTableFromInput() {
                                        let value = parseFloat(fromTableInput.value);
                                        // Ensure value is within bounds
                                        value = Math.max(parseFloat(fromTableSlider.min), value);
                                        value = Math.min(value, parseFloat(toTableInput.value));
                                    ...
                                    function syncTableToInput() {
                                        let value = parseFloat(toTableInput.value);
                                        // Ensure value is within bounds
                                        value = Math.min(parseFloat(toTableSlider.max), value);
                                        value = Math.max(value, parseFloat(fromTableInput.value));
                                    ...
                                    function submitTableForm() {
                                        // Submit with a slight delay to ensure values are updated
                                        setTimeout(() => {
                                            tableForm.submit();
                                        }, 100);
                                    }
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            if (tableIcon && tableDropdown && tableDownArrow && tableUpArrow) {
                                ...
                                // Close dropdown when clicking outside
                                document.addEventListener('click', (e) => {
                                    const fromTableSlider = document.getElementById('fromTableSlider');
                                    const toTableSlider = document.getElementById('toTableSlider');
                                    const fromTableInput = document.getElementById('fromTableInput');
                                    const toTableInput = document.getElementById('toTableInput');

                                    if (!tableIcon.contains(e.target) &&
                                        !tableDropdown.contains(e.target) &&
                                        fromTableSlider && !fromTableSlider.contains(e.target) &&
                                        toTableSlider && !toTableSlider.contains(e.target) &&
                                        fromTableInput && !fromTableInput.contains(e.target) &&
                                        toTableInput && !toTableInput.contains(e.target)) {
                                        tableDropdown.classList.add('hidden');
                                        tableDownArrow.classList.remove('hidden');
                                        tableUpArrow.classList.add('hidden');
                                    }
                    ...
                    <div id="depthDropdownIcon"
                        ...
                        <div id="depthDropdown"
                            ...
                            <div class="flex justify-between">
                                ...
                                <button type="button" class="p-2 rounded-full" id="depthCloseBtn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"
                                        stroke-linecap="round" stroke-linejoin="round" class="text-primary">
                                        <line x1="18" y1="6" x2="6" y2="18"></line>
                            ...
                            <div class="flex items-center p-4">
                                <div class="w-full">
                                    <form id="depthForm" action="{{ route('antique.cut.diamond') }}" method="GET">
                                        <!-- Preserve existing query parameters -->
                                        @foreach (request()->except(['depth_min', 'depth_max']) as $key => $value)
                                            @if (is_array($value))
                                                @foreach ($value as $arrayValue)
                                                    <input type="hidden" name="{{ $key }}[]"
                                                        value="{{ $arrayValue }}">
                                        ...
                                        <div class="flex justify-between">
                                            <div>
                                                <input
                                                    class="form_carat_control_container__carat__input small-input px-1 py-1 text-xs border border-gray-300 focus:outline-none focus:ring-1 focus:ring-primary"
                                                    type="number" id="fromDepthInput" name="depth_min"
                                                    value="{{ request('depth_min', 46.0) }}" min="46.00"
                                                    max="78.00" step="0.01" />
                                            </div>
                                            <div>
                                                <input
                                                    class="form_carat_control_container__carat__input small-input px-1 py-1 text-xs border border-gray-300 focus:outline-none focus:ring-1 focus:ring-primary"
                                                    type="number" id="toDepthInput" name="depth_max"
                                                    value="{{ request('depth_max', 78.0) }}" min="46.00"
                                                    max="78.00" step="0.01" />
                                            </div>
                                        </div>
                                        <div class="relative min-h-7 flex items-center">
                                            <input id="fromDepthSlider" type="range"
                                                value="{{ request('depth_min', 46.0) }}" min="46"
                                                max="78" step="0.01" />
                                            <input id="toDepthSlider" type="range"
                                                value="{{ request('depth_max', 78.0) }}" min="46"
                                                max="78" step="0.01" />
                                        </div>
                                    </form>
                                </div>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const depthCloseBtn = document.getElementById('depthCloseBtn');
                            const fromDepthSlider = document.getElementById('fromDepthSlider');
                            const toDepthSlider = document.getElementById('toDepthSlider');
                            const fromDepthInput = document.getElementById('fromDepthInput');
                            const toDepthInput = document.getElementById('toDepthInput');
                            const depthForm = document.getElementById('depthForm');

                            // Only proceed if elements exist
                            if (depthIcon && depthDropdown && depthDownArrow && depthUpArrow) {
                                ...
                                // Close dropdown when clicking outside
                                document.addEventListener('click', (e) => {
                                    if (!depthIcon.contains(e.target) &&
                                        !depthDropdown.contains(e.target) &&
                                        fromDepthSlider && !fromDepthSlider.contains(e.target) &&
                                        toDepthSlider && !toDepthSlider.contains(e.target) &&
                                        fromDepthInput && !fromDepthInput.contains(e.target) &&
                                        toDepthInput && !toDepthInput.contains(e.target)) {
                            ...
                            // Slider and input functionality
                            if (fromDepthSlider && toDepthSlider && fromDepthInput && toDepthInput && depthForm) {
                                function updateDepthSliderColors() {
                                    const min = parseFloat(fromDepthSlider.min);
                                    const max = parseFloat(toDepthSlider.max);
                                    const from = parseFloat(fromDepthSlider.value);
                                    const to = parseFloat(toDepthSlider.value);
                                ...
                                function syncDepthFromInput() {
                                    let value = parseFloat(fromDepthInput.value);
                                    // Ensure value is within bounds
                                    value = Math.max(parseFloat(fromDepthSlider.min), value);
                                    value = Math.min(value, parseFloat(toDepthInput.value));
                                ...
                                function syncDepthToInput() {
                                    let value = parseFloat(toDepthInput.value);
                                    // Ensure value is within bounds
                                    value = Math.min(parseFloat(toDepthSlider.max), value);
                                    value = Math.max(value, parseFloat(fromDepthInput.value));
                                ...
                                // Event listeners
                                fromDepthInput.addEventListener("change", function() {
                                    syncDepthFromInput();
                                    submitDepthForm();
                                });

                                toDepthInput.addEventListener("change", function() {
                                    syncDepthToInput();
                                    submitDepthForm();
                                });

                                fromDepthSlider.addEventListener("change", function() {
                                    syncDepthFromSlider();
                                    submitDepthForm();
                                });

                                toDepthSlider.addEventListener("change", function() {
                                    syncDepthToSlider();
                                    submitDepthForm();
                                });
                ...
                <!-- End Certificate Dropdown , Method Dropdown , Depth Dropdown -->
                                    ...
                                    <div class="grid grid-cols-2 gap-8 my-10">
                                        ...
                                        <div class="relative flex flex-col items-center gap-3">
                                            ...
                                            <button id="wishlist-btn-{{ $diamond->id }}"
                                                ...
                                                <svg id="wishlist-icon-{{ $diamond->id }}"
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    stroke-width="2" stroke="currentColor"
                                                    class="w-6 h-6 transition-all" fill="white">
                                                    <path id="wishlist-path-{{ $diamond->id }}"
        ...
        <script>
            ...
            `;
                ...
                fetch(`/antique-cut-diamond?${params.toString()}`, {
                        headers: {
