...
@section('content')
    <div class="mb-14">
        ...
        <div class="flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 2xl:px-28 3xl:px-40 my-12">
            <h2 class="text-3xl text-primary font-montserrat font-semibold mb-2">Eternity Rings</h2>
            <p class="text-sm text-primary font-montserrat text-center">An eternity band, also known as the infinity ring, is made of precious metal which is embedded with diamonds surrounding the ring from all sides. Giving it the infinity ring title. This ring signifies an extraordinary and significant moment in a couple's life. An eternity ring is given by one partner to their significant other when their relationship has had an important moment.
            </p>
        </div>
