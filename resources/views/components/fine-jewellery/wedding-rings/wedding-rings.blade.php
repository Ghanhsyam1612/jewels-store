...
<div class="w-full mx-auto mb-10">
    ...
    <div class="flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 xl:px-2 2xl:px-20 my-12">
        ...
        <p class="text-sm 3xl:text-lg text-center font-montserrat text-primary">Stunning Wedding Rings Collection of timeless dazzling pieces that quickly make a statement. Some of the best craftspeople craft each ring in our collection, making every diamond piece produced unique.</p>
    </div>
