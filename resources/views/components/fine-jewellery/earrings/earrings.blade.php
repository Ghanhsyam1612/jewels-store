...
@section('content')
    <div class="container mb-14">
        <nav class="flex items-center text-sm font-montserrat mb-4 px-40 py-6">
            ...
            <span class="text-primary text-xs">Lab Grown Diamond Earrings</span>
        </nav>

        <div class="flex flex-col items-center justify-center px-40 my-12">
            <h2 class="text-3xl text-primary font-montserrat font-semibold mb-2">Lab Grown Diamond Earrings</h2>
