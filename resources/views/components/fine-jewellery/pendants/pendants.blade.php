...
<div class="w-full mx-auto mb-10">
    ...
    <div class="flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 xl:px-2 2xl:px-20 my-12">
        ...
        <p class="text-sm 3xl:text-lg text-center font-montserrat text-primary">A diamond pendant is a piece of jewelry with a diamond in the center. We ought to satisfy consumers with our quality products and services with a varied range of lab-grown diamond pendants.</p>
    </div>
