...
@section('content')
    <div class="container mb-14">
        <nav class="flex items-center text-sm font-montserrat mb-4 px-40 py-6">
            ...
            <span class="text-primary text-xs">Pendants</span>
        </nav>

        <div class="flex flex-col items-center justify-center px-40 my-12">
            <h2 class="text-3xl text-primary font-montserrat font-semibold mb-2">Shop Pendants</h2>
            <p class="text-sm text-primary font-montserrat text-center">A diamond pendant is a piece of jewelry with a diamond in the center. We ought to satisfy consumers with our quality products and services with a varied range of lab-grown diamond pendants.</p>
        </div>


        <div class="grid grid-cols-2 gap-8 px-40">
            <div class="relative border border-light-grey-1">
                <img src="/images/pendants/Diamond-Pendants.webp" alt="Marquise Diamond" class="w-full h-auto">
                <div class="absolute inset-0 flex flex-col items-start justify-center text-white px-8">
                    <h3 class="text-4xl font-bold mb-4 text-primary w-1/2">Princess Cut Diamonds</h3>
            ...
            <div class="relative border border-light-grey-1">
                <img src="/images/pendants/Halo-Pendants.webp" alt="Marquise Diamond" class="w-full h-auto">
                <div class="absolute inset-0 flex flex-col items-start justify-center text-white rounded-lg px-8">
                    <h3 class="text-4xl font-bold mb-4 text-primary w-1/2">Cushion Cut Diamonds</h3>
                    <a href="#" class="bg-white text-primary font-bold font-montserrat border border-primary hover:bg-primary hover:text-white hover:border-primary px-8 py-3 rounded-md transition">Shop Now</a>
                </div>
            </div>
    
            <div class="relative border border-light-grey-1">
                <img src="/images/pendants/Solitaire-Pendants.webp" alt="Marquise Diamond" class="w-full h-auto">
                <div class="absolute inset-0 flex flex-col items-start justify-center text-white px-8">
                    <h3 class="text-4xl font-bold mb-4 text-primary w-1/2">Heart Shape Diamonds</h3>
                    <a href="#" class="bg-white text-primary font-bold font-montserrat border border-primary hover:bg-primary hover:text-white hover:border-primary px-8 py-3 rounded-md transition">Shop Now</a>
                </div>
            </div>
        </div>
