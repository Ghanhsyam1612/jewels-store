    ...
    @section('content')
        <div class="mb-14">
            ...
            <div class="flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 2xl:px-28 3xl:px-40 my-12">
                <h2 class="text-3xl text-primary font-montserrat font-semibold mb-2">Diamond Pendants</h2>
                <p class="text-sm text-primary font-montserrat text-center">A diamond pendant, as the name suggests, consists of a big diamond in the middle, which is attached to a necklace made up of precious metal, most preferably gold or platinum. However, metal and diamond are not the characteristics that a diamond pendant is sought after. The most important reason is that it signifies eternity means never-ending. A diamond pendant is given by one couple to another, indicating their never-ending love.
                </p>
            </div>
