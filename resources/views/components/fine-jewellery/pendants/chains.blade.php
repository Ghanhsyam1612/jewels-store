...
@section('content')
    <div class="mb-14">
        ...
        <div class="flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 2xl:px-28 3xl:px-40 my-12">
            <h2 class="text-3xl text-primary font-montserrat font-semibold mb-2">Chains</h2>
            <p class="text-sm text-primary font-montserrat text-center">Chains beautifully enhance the look of your neck. Whether worn alone or adorned with pendants, they make the perfect accessory for any occasion.</p>
        </div>
