...
@section('content')
    <div class="container mb-14">
        ...
        <div class="flex flex-col items-center justify-center px-40 my-12">
            <h2 class="text-3xl text-primary font-montserrat font-semibold mb-2">Shop Bracelets</h2>
            <p class="text-sm text-primary font-montserrat text-center">Bracelets are the pieces when it comes to making a statement. These pieces are essential and can easily complement anything and everything. They can break or make your outfit. Here, we provide the most sought-after bracelets that will surely meet your needs.</p>
        </div>
        ...
        <div class="grid grid-cols-2 gap-8 px-40">
            <div class="relative border border-light-grey-1">
                ...
                <div class="absolute inset-0 flex flex-col items-start justify-center text-white px-8">
                    <h3 class="text-4xl font-bold mb-4 text-primary w-1/2">Solitaire bracelets</h3>
            ...
            <div class="relative border border-light-grey-1">
                ...
                <div class="absolute inset-0 flex flex-col items-start justify-center text-white rounded-lg px-8">
                    <h3 class="text-4xl font-bold mb-4 text-primary w-1/2">Tennis Bracelets</h3>
                    <a href="#" class="bg-white text-primary font-bold font-montserrat border border-primary hover:bg-primary hover:text-white hover:border-primary px-8 py-3 rounded-md transition">Shop Now</a>
                </div>
            </div>
        </div>
