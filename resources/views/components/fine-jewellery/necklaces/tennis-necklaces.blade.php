...
@section('content')
    <div class="mb-14">
        <nav class="flex flex-wrap items-center text-sm font-montserrat mb-4 px-4 md:px-8 lg:px-12 2xl:px-28 3xl:px-40 py-3">
            ...
            <a href="/all-diamond-necklaces" class="text-primary font-medium text-xs">Diamond Necklaces</a>
            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
        ...
        <div class="flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 2xl:px-28 3xl:px-40 my-12">
            <h2 class="text-3xl text-primary font-montserrat font-semibold mb-2">Diamond Necklaces</h2>
            <p class="text-sm text-primary font-montserrat text-center">Ideal for any event, our breathtaking classic & sustainable tennis necklaces with lab-grown diamonds showcase the beauty and sophistication of American style and artistry. These stunning pieces are meticulously crafted in the USA and adorned with 100% lab-created certified diamonds.</p>
        </div>
