...
@section('content')
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl flex flex-col lg:flex-row justify-center gap-8 w-full">
            <!-- Login Form -->
            <div
                class="w-full bg-white rounded-lg shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)] p-8">
                <div>
                ...
                <form id="loginForm" class="mt-8 space-y-6" action="{{ route('customer.login') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="email-address" class="block text-sm font-medium font-montserrat text-gray-700">Email
                                address <span class="text-red-500">*</span></label>
                            <input id="email-address" name="email" type="email" autocomplete="email"
                                class="appearance-none rounded-md relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm font-montserrat"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <button type="button" onclick="openResetModal()"
                                class="font-medium text-gray-600 hover:text-dark-blue font-montserrat">
                    ...
                    <div class="mt-6">
                        <button type="submit"
                            class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md tracking-wide text-white bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 font-montserrat">
                            Sign in
                        </button>
                    </div>
                </form>
            ...
            <div
                ...
                <form id="registerForm" class="mt-8 space-y-6" action="{{ route('customer.store') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="full_name" class="block text-sm font-medium font-montserrat text-gray-700">Full Name
                        ...
                        <div>
                            <label for="register-email"
                                class="block text-sm font-medium font-montserrat text-gray-700">Email address <span
